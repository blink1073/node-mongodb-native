...
## [7.0.0](https://github.com/blink1073/node-mongodb-native/compare/v6.10.0...v7.0.0) (2024-11-11)


### ⚠ BREAKING CHANGES

* **NODE-5584:** adopt bson v6 and mongodb-client-encryption v6 ([#3845](https://github.com/blink1073/node-mongodb-native/issues/3845))
* **NODE-5484:** mark MongoError for internal use and remove Node14 cause assignment logic ([#3800](https://github.com/blink1073/node-mongodb-native/issues/3800))
* **NODE-4788:** use implementer Writable methods for GridFSBucketWriteStream  ([#3808](https://github.com/blink1073/node-mongodb-native/issues/3808))
* **NODE-4986:** remove callbacks from ClientEncryption encrypt, decrypt, and createDataKey ([#3797](https://github.com/blink1073/node-mongodb-native/issues/3797))
* **NODE-5490:** bump kerberos compatibility to ^2.0.1 ([#3798](https://github.com/blink1073/node-mongodb-native/issues/3798))
* **NODE-3568:** ensure includeResultsMetadata is false by default ([#3786](https://github.com/blink1073/node-mongodb-native/issues/3786))
* **NODE-3989:** only accept true and false for boolean options ([#3791](https://github.com/blink1073/node-mongodb-native/issues/3791))
* **NODE-5233:** prevent session from one client from being used on another ([#3790](https://github.com/blink1073/node-mongodb-native/issues/3790))
* **NODE-5444:** emit deprecation warning for useNewUrlParser and useUnifiedTopology ([#3792](https://github.com/blink1073/node-mongodb-native/issues/3792))
* **NODE-5470:** convert remaining FLE to TS and drop support for `onKMSProvidersRefresh` ([#3787](https://github.com/blink1073/node-mongodb-native/issues/3787))
* **NODE-5508:** remove EvalOperation and EvalOptions ([#3795](https://github.com/blink1073/node-mongodb-native/issues/3795))
* **NODE-3920:** validate options are not repeated in connection string ([#3788](https://github.com/blink1073/node-mongodb-native/issues/3788))
* **NODE-3924:** read tls files async ([#3776](https://github.com/blink1073/node-mongodb-native/issues/3776))
* **NODE-5430:** make AutoEncrypter and MongoClient.autoEncrypter internal ([#3789](https://github.com/blink1073/node-mongodb-native/issues/3789))
* **NODE-4961:** remove command result from commit and abort transaction APIs ([#3784](https://github.com/blink1073/node-mongodb-native/issues/3784))
* **NODE-2014:** return executor result from withSession and withTransaction ([#3783](https://github.com/blink1073/node-mongodb-native/issues/3783))
* **NODE-5409:** allow socks to be installed optionally ([#3782](https://github.com/blink1073/node-mongodb-native/issues/3782))
* **NODE-4796:** remove addUser and collection.stats APIs ([#3781](https://github.com/blink1073/node-mongodb-native/issues/3781))
* **NODE-4936:** remove unsupported options from db.command and admin.command ([#3775](https://github.com/blink1073/node-mongodb-native/issues/3775))
* **NODE-5228:** remove unneeded fields from ConnectionPoolCreatedEvent.options ([#3772](https://github.com/blink1073/node-mongodb-native/issues/3772))
* **NODE-5190:** remove deprecated keep alive options ([#3771](https://github.com/blink1073/node-mongodb-native/issues/3771))
* **NODE-5186:** remove duplicate BulkWriteResult accessors ([#3766](https://github.com/blink1073/node-mongodb-native/issues/3766))
* **NODE-5376:** remove deprecated ssl options ([#3755](https://github.com/blink1073/node-mongodb-native/issues/3755))
* **NODE-5415:** bump minimum Node.js version to v16.20.1 ([#3760](https://github.com/blink1073/node-mongodb-native/issues/3760))

### Features

* **NODE-2014:** return executor result from withSession and withTransaction ([#3783](https://github.com/blink1073/node-mongodb-native/issues/3783)) ([65aa288](https://github.com/blink1073/node-mongodb-native/commit/65aa288a28a9e8859f4fd75f176961ef3d9747f0))
* **NODE-3449:** Add serverConnectionId to Command Monitoring Spec ([735f7aa](https://github.com/blink1073/node-mongodb-native/commit/735f7aa17c2403044c015c0eb0fc7e4be08c0983))
* **NODE-3470:** retry selects another mongos ([#3963](https://github.com/blink1073/node-mongodb-native/issues/3963)) ([84959ee](https://github.com/blink1073/node-mongodb-native/commit/84959ee27135abd04e4009b0adfebc7889d9139f))
* **NODE-3568:** ensure includeResultsMetadata is false by default ([#3786](https://github.com/blink1073/node-mongodb-native/issues/3786)) ([fee8d3e](https://github.com/blink1073/node-mongodb-native/commit/fee8d3e094846222035962c75a207e14b70325c7))
* **NODE-3639:** add a general stage to the aggregation pipeline builder ([#4079](https://github.com/blink1073/node-mongodb-native/issues/4079)) ([8fca1aa](https://github.com/blink1073/node-mongodb-native/commit/8fca1aaaeb611e26745c837868b7e7f47b287ad5))
* **NODE-3689:** require hello command for connection handshake to use OP_MSG disallowing OP_QUERY ([#3938](https://github.com/blink1073/node-mongodb-native/issues/3938)) ([ce7df0f](https://github.com/blink1073/node-mongodb-native/commit/ce7df0f79ed764d4a36caf1562cea4f5015c0ea6))
* **NODE-3881:** require hello command + OP_MSG when 'loadBalanced=True' ([#3907](https://github.com/blink1073/node-mongodb-native/issues/3907)) ([fd58eec](https://github.com/blink1073/node-mongodb-native/commit/fd58eec441d99493aff5c62bcc170c469efa679b))
* **NODE-3920:** validate options are not repeated in connection string ([#3788](https://github.com/blink1073/node-mongodb-native/issues/3788)) ([11631a2](https://github.com/blink1073/node-mongodb-native/commit/11631a2b63e7102602ce2b2e452fd61ee5a46d05))
* **NODE-3924:** read tls files async ([#3776](https://github.com/blink1073/node-mongodb-native/issues/3776)) ([68adaf1](https://github.com/blink1073/node-mongodb-native/commit/68adaf1e5d5ee8cf8f0468380d7a7b3113facc07))
* **NODE-3989:** only accept true and false for boolean options ([#3791](https://github.com/blink1073/node-mongodb-native/issues/3791)) ([e2e36cc](https://github.com/blink1073/node-mongodb-native/commit/e2e36ccbb30de217d7ca2014d8591b574360d557))
* **NODE-4686:** Add log messages to CLAM ([#3955](https://github.com/blink1073/node-mongodb-native/issues/3955)) ([e3bfa30](https://github.com/blink1073/node-mongodb-native/commit/e3bfa30eefe6b0a79141b32029d8e44d426275d6))
* **NODE-4687:** Add logging to server selection ([#3946](https://github.com/blink1073/node-mongodb-native/issues/3946)) ([7f3ce0b](https://github.com/blink1073/node-mongodb-native/commit/7f3ce0bb8d4173739e5a3ffe9041dd11b28f9b08))
* **NODE-4719:** add SDAM Logging Spec ([#3940](https://github.com/blink1073/node-mongodb-native/issues/3940)) ([a3c0298](https://github.com/blink1073/node-mongodb-native/commit/a3c02983bc9cead125373d86a5c47cf8f4e40f9e))
* **NODE-4720:** Add log messages to CMAP spec ([#3645](https://github.com/blink1073/node-mongodb-native/issues/3645)) ([b27f385](https://github.com/blink1073/node-mongodb-native/commit/b27f385fe6a2bc53b3902465a570d832f52df4e6))
* **NODE-4796:** remove addUser and collection.stats APIs ([#3781](https://github.com/blink1073/node-mongodb-native/issues/3781)) ([e79ac9d](https://github.com/blink1073/node-mongodb-native/commit/e79ac9da9fce35e1ea9b26fc4a97a79826a6a687))
* **NODE-4814:** implement remaining severity logging methods ([#3629](https://github.com/blink1073/node-mongodb-native/issues/3629)) ([d7a8079](https://github.com/blink1073/node-mongodb-native/commit/d7a80790d8f629e25ff090ef8c2d8c6a7b0b0a07))
* **NODE-4815:** stringify and truncate BSON documents in log messages ([#3635](https://github.com/blink1073/node-mongodb-native/issues/3635)) ([d6bd1d1](https://github.com/blink1073/node-mongodb-native/commit/d6bd1d1602c213e5c46a702163351d1865cdc727))
* **NODE-4847:** Add config error handling to logging ([#3970](https://github.com/blink1073/node-mongodb-native/issues/3970)) ([8f7bb59](https://github.com/blink1073/node-mongodb-native/commit/8f7bb593cbd1b2cd69c76702dbd1125479d1055a))
* **NODE-4849:** Add Typescript support for log path in client options ([#3886](https://github.com/blink1073/node-mongodb-native/issues/3886)) ([f495abb](https://github.com/blink1073/node-mongodb-native/commit/f495abb0e25755e867b311a19c8cd35a4c606aa4))
* **NODE-4878:** Add remaining log configurable client options ([#3908](https://github.com/blink1073/node-mongodb-native/issues/3908)) ([54adc9f](https://github.com/blink1073/node-mongodb-native/commit/54adc9f65b5924ffa9730a9adf0a8162a284277e))
* **NODE-4929:** Add OIDC Azure workflow ([#3670](https://github.com/blink1073/node-mongodb-native/issues/3670)) ([b3482f3](https://github.com/blink1073/node-mongodb-native/commit/b3482f32551ea5fcfefa861eca52961a99c82fe3))
* **NODE-4961:** remove command result from commit and abort transaction APIs ([#3784](https://github.com/blink1073/node-mongodb-native/issues/3784)) ([71c5936](https://github.com/blink1073/node-mongodb-native/commit/71c593685735a08d5d7503120464a7c23ba20a46))
* **NODE-4970:** deprecate collStats collection helper ([#3638](https://github.com/blink1073/node-mongodb-native/issues/3638)) ([325c4bc](https://github.com/blink1073/node-mongodb-native/commit/325c4bc37decdf12e957bfad8bd4ee4d28b1bf95))
* **NODE-4986:** remove callbacks from ClientEncryption encrypt, decrypt, and createDataKey ([#3797](https://github.com/blink1073/node-mongodb-native/issues/3797)) ([51a573f](https://github.com/blink1073/node-mongodb-native/commit/51a573fe99506b81c7ab808898eb9eb63f58f600))
* **NODE-5004:** dont create or drop ecc collections ([#3660](https://github.com/blink1073/node-mongodb-native/issues/3660)) ([2264fbb](https://github.com/blink1073/node-mongodb-native/commit/2264fbb5a9c99ced4cb3c3d71ff2a59e4505f898))
* **NODE-5008:** add zstd and kerberos to peer deps ([#3691](https://github.com/blink1073/node-mongodb-native/issues/3691)) ([9561f32](https://github.com/blink1073/node-mongodb-native/commit/9561f32a9dda6969be7f727c9bd1bd96980f5e95))
* **NODE-5019:** add runCursorCommand API ([#3655](https://github.com/blink1073/node-mongodb-native/issues/3655)) ([4da926e](https://github.com/blink1073/node-mongodb-native/commit/4da926e0989b97cfbdf8384bd197dd6ed204fd12))
* **NODE-5071:** support additional time series options ([#3667](https://github.com/blink1073/node-mongodb-native/issues/3667)) ([ccf555d](https://github.com/blink1073/node-mongodb-native/commit/ccf555d069f3bd0eb7e7b2cca0d5ecdc7d571332))
* **NODE-5166:** bump max wire version for 7.0 ([#3659](https://github.com/blink1073/node-mongodb-native/issues/3659)) ([561229b](https://github.com/blink1073/node-mongodb-native/commit/561229ba53c2ea422da01625adf5597556332fee))
* **NODE-5169:** Implement emergency logger ([#3610](https://github.com/blink1073/node-mongodb-native/issues/3610)) ([d502eb0](https://github.com/blink1073/node-mongodb-native/commit/d502eb0eb1d2f56ae3603a2da665a79040bc898c))
* **NODE-5186:** remove duplicate BulkWriteResult accessors ([#3766](https://github.com/blink1073/node-mongodb-native/issues/3766)) ([8693987](https://github.com/blink1073/node-mongodb-native/commit/8693987b66dff745c8421ac9cdc29dc772b1f675))
* **NODE-5188:** add alternative runtime detection to client metadata ([#3636](https://github.com/blink1073/node-mongodb-native/issues/3636)) ([2a26de3](https://github.com/blink1073/node-mongodb-native/commit/2a26de3a2cd95b4fc21918a96dd21dc4bc62000a))
* **NODE-5190:** remove deprecated keep alive options ([#3771](https://github.com/blink1073/node-mongodb-native/issues/3771)) ([7ade907](https://github.com/blink1073/node-mongodb-native/commit/7ade9079fa78538069604a5b42ad13ffbb80af46))
* **NODE-5191:** OIDC Auth Updates ([#3637](https://github.com/blink1073/node-mongodb-native/issues/3637)) ([c52a4ed](https://github.com/blink1073/node-mongodb-native/commit/c52a4edfb79934249ea58703b9ddd4a94ef34418))
* **NODE-5197:** add server monitoring mode ([#3899](https://github.com/blink1073/node-mongodb-native/issues/3899)) ([ae4c94a](https://github.com/blink1073/node-mongodb-native/commit/ae4c94a1ac8bd402c047263e39a55d65488cc2a3))
* **NODE-5207:** deprecate unsupported runCommand options and add spec tests ([#3643](https://github.com/blink1073/node-mongodb-native/issues/3643)) ([d6d76b4](https://github.com/blink1073/node-mongodb-native/commit/d6d76b4f239ab3d53e867a5c9ace9e18aa12886a))
* **NODE-5233:** prevent session from one client from being used on another ([#3790](https://github.com/blink1073/node-mongodb-native/issues/3790)) ([9268b35](https://github.com/blink1073/node-mongodb-native/commit/9268b35d5ba0736ff38e691024d89f1ac6c28515))
* **NODE-5241:** add option to return modified document ([#3710](https://github.com/blink1073/node-mongodb-native/issues/3710)) ([d9c2600](https://github.com/blink1073/node-mongodb-native/commit/d9c2600daf3bb6c8106e0f3a27cb2f12b770c8eb))
* **NODE-5243:** add change stream split event ([#3745](https://github.com/blink1073/node-mongodb-native/issues/3745)) ([1c84f82](https://github.com/blink1073/node-mongodb-native/commit/1c84f82424acb23b510fdc10e64f304eafecfc1d))
* **NODE-5274:** deprecate write concern options ([#3752](https://github.com/blink1073/node-mongodb-native/issues/3752)) ([1f880ea](https://github.com/blink1073/node-mongodb-native/commit/1f880eaea6e3bc2aa0bf48a70d020a4f9271286d))
* **NODE-5287:** deprecate ssl options ([#3743](https://github.com/blink1073/node-mongodb-native/issues/3743)) ([f9b5677](https://github.com/blink1073/node-mongodb-native/commit/f9b5677657a05b22cc47c20f910e6ae264da8717))
* **NODE-5314:** add search index helpers ([#3672](https://github.com/blink1073/node-mongodb-native/issues/3672)) ([f647542](https://github.com/blink1073/node-mongodb-native/commit/f64754211fe9c142558e3fe9db3adf606d204fc9))
* **NODE-5319:** mark search index api public ([#3741](https://github.com/blink1073/node-mongodb-native/issues/3741)) ([c015e54](https://github.com/blink1073/node-mongodb-native/commit/c015e5446dbeccfa4d63a4a6f46d06add74deb8b))
* **NODE-5376:** remove deprecated ssl options ([#3755](https://github.com/blink1073/node-mongodb-native/issues/3755)) ([ee56c8e](https://github.com/blink1073/node-mongodb-native/commit/ee56c8eebf22b2f90885513e699d209c63379846))
* **NODE-5396:** add `mongodb-js/saslprep` as a required dependency ([#3815](https://github.com/blink1073/node-mongodb-native/issues/3815)) ([bd031fc](https://github.com/blink1073/node-mongodb-native/commit/bd031fc26bdbae7ac8a73cccc06e11da7160d656))
* **NODE-5407:** update bson to 5.4.0 ([#3754](https://github.com/blink1073/node-mongodb-native/issues/3754)) ([6a574cf](https://github.com/blink1073/node-mongodb-native/commit/6a574cf94e8cb923ff33f3a1d241a33d7fd90eb0))
* **NODE-5409:** allow socks to be installed optionally ([#3782](https://github.com/blink1073/node-mongodb-native/issues/3782)) ([787bdbf](https://github.com/blink1073/node-mongodb-native/commit/787bdbf3f7bd974aca1347de427e973217c90009))
* **NODE-5415:** bump minimum Node.js version to v16.20.1 ([#3760](https://github.com/blink1073/node-mongodb-native/issues/3760)) ([de158b2](https://github.com/blink1073/node-mongodb-native/commit/de158b245d809e6600c178303a033997d4181ade))
* **NODE-5430:** make AutoEncrypter and MongoClient.autoEncrypter internal ([#3789](https://github.com/blink1073/node-mongodb-native/issues/3789)) ([b16ef9e](https://github.com/blink1073/node-mongodb-native/commit/b16ef9ed2cbb141c1c8c071ed0d51bc0993dc423))
* **NODE-5444:** emit deprecation warning for useNewUrlParser and useUnifiedTopology ([#3792](https://github.com/blink1073/node-mongodb-native/issues/3792)) ([c08060d](https://github.com/blink1073/node-mongodb-native/commit/c08060d074dfe6f222feb360589ac52f9fa90b6d))
* **NODE-5452:** Logging Cosmos Document DB Info Message ([#3902](https://github.com/blink1073/node-mongodb-native/issues/3902)) ([bb5fa43](https://github.com/blink1073/node-mongodb-native/commit/bb5fa43ce58f11d4961f1feaa0d6e58ef6bd8378))
* **NODE-5459:** add durations to connection pool events ([#4166](https://github.com/blink1073/node-mongodb-native/issues/4166)) ([7295695](https://github.com/blink1073/node-mongodb-native/commit/729569527e353a942200533f6150e748454c798d))
* **NODE-5464:** OIDC machine and callback workflow ([#3912](https://github.com/blink1073/node-mongodb-native/issues/3912)) ([2ba8434](https://github.com/blink1073/node-mongodb-native/commit/2ba8434d10aa02ddf281482cc02ef168c1b2965c))
* **NODE-5470:** convert remaining FLE to TS and drop support for `onKMSProvidersRefresh` ([#3787](https://github.com/blink1073/node-mongodb-native/issues/3787)) ([844aa52](https://github.com/blink1073/node-mongodb-native/commit/844aa52640baf69c0b6dacdb3d11add4ca24d8f2))
* **NODE-5484:** mark MongoError for internal use and remove Node14 cause assignment logic ([#3800](https://github.com/blink1073/node-mongodb-native/issues/3800)) ([a17b0af](https://github.com/blink1073/node-mongodb-native/commit/a17b0af1a2ae112b7e96da86a8761d5c15d616cf))
* **NODE-5490:** bump kerberos compatibility to ^2.0.1 ([#3798](https://github.com/blink1073/node-mongodb-native/issues/3798)) ([1044be1](https://github.com/blink1073/node-mongodb-native/commit/1044be14ca69ea4c367bf79735894deadf166d6e))
* **NODE-5508:** remove EvalOperation and EvalOptions ([#3795](https://github.com/blink1073/node-mongodb-native/issues/3795)) ([225cb81](https://github.com/blink1073/node-mongodb-native/commit/225cb8184295c6ad934571c2a0cb7ef6bcf8af50))
* **NODE-5566:** add ability to provide CRL file via tlsCRLFile ([#3834](https://github.com/blink1073/node-mongodb-native/issues/3834)) ([33c86c9](https://github.com/blink1073/node-mongodb-native/commit/33c86c923e0ccfcb61f670c31efd145542bd4980))
* **NODE-5584:** adopt bson v6 and mongodb-client-encryption v6 ([#3845](https://github.com/blink1073/node-mongodb-native/issues/3845)) ([7bef363](https://github.com/blink1073/node-mongodb-native/commit/7bef3632da73f20431952b99a0d11e9aac001c12))
* **NODE-5590:** deprecate GridFS fields ([#3905](https://github.com/blink1073/node-mongodb-native/issues/3905)) ([d2225da](https://github.com/blink1073/node-mongodb-native/commit/d2225da322d9367a9216e554e7fe927fb1cd08aa))
* **NODE-5613:** add `awaited` field to SDAM heartbeat events ([#3895](https://github.com/blink1073/node-mongodb-native/issues/3895)) ([b50aadc](https://github.com/blink1073/node-mongodb-native/commit/b50aadca7e5e471283ebaccff5b98c099c57fa55))
* **NODE-5614:** add support for explicit resource management ([#4177](https://github.com/blink1073/node-mongodb-native/issues/4177)) ([b3f3987](https://github.com/blink1073/node-mongodb-native/commit/b3f3987041ddf0aae86044f3fdd1364eecd26d46))
* **NODE-5634:** bump bson version to ^6.1.0 ([#3866](https://github.com/blink1073/node-mongodb-native/issues/3866)) ([c6edabb](https://github.com/blink1073/node-mongodb-native/commit/c6edabb8fa4c6f8d80b028a96eacd26975460f8a))
* **NODE-5678:** add options parsing support for timeoutMS and defaultTimeoutMS ([#4068](https://github.com/blink1073/node-mongodb-native/issues/4068)) ([ddd1e81](https://github.com/blink1073/node-mongodb-native/commit/ddd1e81c970ae16b8b7adc7045832462d283e43c))
* **NODE-5682:** set maxTimeMS on commands and preempt I/O ([#4174](https://github.com/blink1073/node-mongodb-native/issues/4174)) ([e4e6a5e](https://github.com/blink1073/node-mongodb-native/commit/e4e6a5e9bff4e30f67e728990012bf0e8ee3e1ff))
* **NODE-5717:** make ExceededTimeLimit retryable reads error ([#3947](https://github.com/blink1073/node-mongodb-native/issues/3947)) ([106ab09](https://github.com/blink1073/node-mongodb-native/commit/106ab092d0fe184509551c55b6b0fe817fa6ba21))
* **NODE-5718:** add ReadConcernMajorityNotAvailableYet to retryable errors ([#4154](https://github.com/blink1073/node-mongodb-native/issues/4154)) ([4f32dec](https://github.com/blink1073/node-mongodb-native/commit/4f32decc354b222a6fe824a668d0b7b9db930f5f))
* **NODE-5754:** allow auto select family options ([#4185](https://github.com/blink1073/node-mongodb-native/issues/4185)) ([54efb7d](https://github.com/blink1073/node-mongodb-native/commit/54efb7d497f8efb9953f5d315267e299ed4cf5af))
* **NODE-5762:** include `cause` and package name for all `MongoMissingDependencyError`s ([#4067](https://github.com/blink1073/node-mongodb-native/issues/4067)) ([62ea94b](https://github.com/blink1073/node-mongodb-native/commit/62ea94b9f529d1b850c77fb5219014159b4d27ab))
* **NODE-5801:** allow multiple providers providers per type ([#4137](https://github.com/blink1073/node-mongodb-native/issues/4137)) ([4d209ce](https://github.com/blink1073/node-mongodb-native/commit/4d209ce7aa92ac543f6b106d94a65508858ccf51))
* **NODE-5825:** add `minRoundTripTime` to `ServerDescription` and change `roundTripTime` to a moving average ([#4059](https://github.com/blink1073/node-mongodb-native/issues/4059)) ([0e3d6ea](https://github.com/blink1073/node-mongodb-native/commit/0e3d6ead735ed067bd044c8d0c9c307d970f1986))
* **NODE-5838:** remove support for server 3.6 ([#4182](https://github.com/blink1073/node-mongodb-native/issues/4182)) ([7b71e1f](https://github.com/blink1073/node-mongodb-native/commit/7b71e1fdc179a9e0628a6b23519e3c00acaadf22))
* **NODE-5844:** add iscryptd to ServerDescription ([#4239](https://github.com/blink1073/node-mongodb-native/issues/4239)) ([c39d443](https://github.com/blink1073/node-mongodb-native/commit/c39d443027368f927e58fbabb88b50b8f3e2e8a8))
* **NODE-5853:** support delegated KMIP data key option ([#4129](https://github.com/blink1073/node-mongodb-native/issues/4129)) ([aa429f8](https://github.com/blink1073/node-mongodb-native/commit/aa429f8c471b6ac23d9ffc33c9d40e1dc116c75b))
* **NODE-5885:** upgrade BSON to `^6.3.0` ([#3983](https://github.com/blink1073/node-mongodb-native/issues/3983)) ([9401d09](https://github.com/blink1073/node-mongodb-native/commit/9401d09af4def8bfbeff65e70863be5d13b3dd61))
* **NODE-5908:** support range v2 ([#4141](https://github.com/blink1073/node-mongodb-native/issues/4141)) ([de253a7](https://github.com/blink1073/node-mongodb-native/commit/de253a749f1dd1194b6fbc30c36e88f906981bd3))
* **NODE-5919:** support new `type` option in create search index helpers ([#4060](https://github.com/blink1073/node-mongodb-native/issues/4060)) ([3598c23](https://github.com/blink1073/node-mongodb-native/commit/3598c23bff588f4f05f0f456261eb558d6f48cbf))
* **NODE-5939:** Implement 6.x: cache the AWS credentials provider in the MONGODB-AWS auth logic ([#3991](https://github.com/blink1073/node-mongodb-native/issues/3991)) ([e0a37e5](https://github.com/blink1073/node-mongodb-native/commit/e0a37e594919d173762b0c64a24bb0291b159fa5))
* **NODE-5968:** container and Kubernetes awareness in client metadata ([#4005](https://github.com/blink1073/node-mongodb-native/issues/4005)) ([28b7040](https://github.com/blink1073/node-mongodb-native/commit/28b70408d0153e6b1118f3dd9cfbcfa30abe29f0))
* **NODE-5978:** upgrade BSON to ^6.4.0 ([#4007](https://github.com/blink1073/node-mongodb-native/issues/4007)) ([90f2f70](https://github.com/blink1073/node-mongodb-native/commit/90f2f70ba61e598fd3c69c1e2a5ae4297fe8f333))
* **NODE-5988:** Provide access to raw results doc on MongoServerError ([#4016](https://github.com/blink1073/node-mongodb-native/issues/4016)) ([c023242](https://github.com/blink1073/node-mongodb-native/commit/c02324218db18e7c51f5b775f35edacc084762b0))
* **NODE-6008:** deprecate CloseOptions interface ([#4030](https://github.com/blink1073/node-mongodb-native/issues/4030)) ([f6cd8d9](https://github.com/blink1073/node-mongodb-native/commit/f6cd8d991b8dc8ca6d28964e46839c79727de669))
* **NODE-6020:** upgrade BSON to ^6.5.0 ([#4035](https://github.com/blink1073/node-mongodb-native/issues/4035)) ([8ab2055](https://github.com/blink1073/node-mongodb-native/commit/8ab205569436a629f8b7b8bbc7f6cb29a3939864))
* **NODE-6060:** set fire-and-forget protocol when writeConcern is w: 0 ([#4219](https://github.com/blink1073/node-mongodb-native/issues/4219)) ([643a875](https://github.com/blink1073/node-mongodb-native/commit/643a87553b5314abb44bcdc342a8bb8cb51d2052))
* **NODE-6069:** OIDC k8s machine workflow ([#4270](https://github.com/blink1073/node-mongodb-native/issues/4270)) ([82c931c](https://github.com/blink1073/node-mongodb-native/commit/82c931c704d30f1a9555519d1ac2c9e03a2e69c4))
* **NODE-6090:** Implement CSOT logic for connection checkout and server selection ([bd8a9f4](https://github.com/blink1073/node-mongodb-native/commit/bd8a9f44f37159c494957cbe9d343b08d98bf128))
* **NODE-6136:** parse cursor responses on demand ([#4112](https://github.com/blink1073/node-mongodb-native/issues/4112)) ([3ed6a2a](https://github.com/blink1073/node-mongodb-native/commit/3ed6a2adf552159bc8526b096ace59f0d5800c96))
* **NODE-6157:** add signature to github releases ([#4119](https://github.com/blink1073/node-mongodb-native/issues/4119)) ([f38c5fe](https://github.com/blink1073/node-mongodb-native/commit/f38c5fe3990f279194523c906dc646bbcc29cbe9))
* **NODE-6225:** add property ownership check before referencing `mongocryptdSpawnPath` and `mongocryptdSpawnArgs` ([#4151](https://github.com/blink1073/node-mongodb-native/issues/4151)) ([f48f8d3](https://github.com/blink1073/node-mongodb-native/commit/f48f8d36cf96c25ebf656e359e97b61dbfe7c4ed))
* **NODE-6231:** Add CSOT behaviour for retryable reads and writes ([#4186](https://github.com/blink1073/node-mongodb-native/issues/4186)) ([2ffd5eb](https://github.com/blink1073/node-mongodb-native/commit/2ffd5eb125bc4b6e444458569728e8698bc71d1a))
* **NODE-6244:** Bump max supported wire version and server version ([#4163](https://github.com/blink1073/node-mongodb-native/issues/4163)) ([45bc098](https://github.com/blink1073/node-mongodb-native/commit/45bc0982f0f00e1811baf2a613989a808783b8b1))
* **NODE-6252:** insertMany and bulkWrite permit readonly arrays ([#4175](https://github.com/blink1073/node-mongodb-native/issues/4175)) ([4b219d3](https://github.com/blink1073/node-mongodb-native/commit/4b219d361b6309dcec480c2bc7e54f548201c15b))
* **NODE-6274:** add CSOT support to bulkWrite ([#4250](https://github.com/blink1073/node-mongodb-native/issues/4250)) ([c5a9ae5](https://github.com/blink1073/node-mongodb-native/commit/c5a9ae55f8baecd0460bef688d66336bb1b86415))
* **NODE-6275:** Add CSOT support to GridFS ([#4246](https://github.com/blink1073/node-mongodb-native/issues/4246)) ([3cb8187](https://github.com/blink1073/node-mongodb-native/commit/3cb8187057aba0bed57da0fef7ffad20d451a7d0))
* **NODE-6278:** deprecate 3.6 servers ([#4178](https://github.com/blink1073/node-mongodb-native/issues/4178)) ([35d8840](https://github.com/blink1073/node-mongodb-native/commit/35d88404aad343dfbff502fd350bb22a241fed2a))
* **NODE-6289:** allow valid srv hostnames with less than 3 parts ([#4197](https://github.com/blink1073/node-mongodb-native/issues/4197)) ([3d5bd51](https://github.com/blink1073/node-mongodb-native/commit/3d5bd513b590f8de91a3edb0a6d2a9d81a4666e2))
* **NODE-6304:** add CSOT support for non-tailable cursors ([#4195](https://github.com/blink1073/node-mongodb-native/issues/4195)) ([131f6ed](https://github.com/blink1073/node-mongodb-native/commit/131f6ed63bef473b5e4ce1062c864c58a48bd092))
* **NODE-6305:** Add CSOT support to tailable cursors ([#4218](https://github.com/blink1073/node-mongodb-native/issues/4218)) ([2398fc6](https://github.com/blink1073/node-mongodb-native/commit/2398fc6b4a13b6c615315df2a1b8b8ffb737d8c3))
* **NODE-6309:** Mark range API as stable ([#4190](https://github.com/blink1073/node-mongodb-native/issues/4190)) ([f53e9d9](https://github.com/blink1073/node-mongodb-native/commit/f53e9d9cebdfaac5edd0e46ee46f1c2eb5b7f8ae))
* **NODE-6312:** add error transformation for server timeouts ([#4192](https://github.com/blink1073/node-mongodb-native/issues/4192)) ([c2c0cb9](https://github.com/blink1073/node-mongodb-native/commit/c2c0cb9eb22adc2d61611d3aa965f9062f5089a0))
* **NODE-6313:** add CSOT support to sessions and transactions ([#4199](https://github.com/blink1073/node-mongodb-native/issues/4199)) ([5f1102f](https://github.com/blink1073/node-mongodb-native/commit/5f1102f0e9cd8de908a33f615cd03a4fefc9d916))
* **NODE-6327:** new client bulk write types and builders ([#4205](https://github.com/blink1073/node-mongodb-native/issues/4205)) ([6d65ae7](https://github.com/blink1073/node-mongodb-native/commit/6d65ae77835cf144b540a5a344e1f10bb1988bc5))
* **NODE-6329:** client bulk write happy path ([#4206](https://github.com/blink1073/node-mongodb-native/issues/4206)) ([3d3da40](https://github.com/blink1073/node-mongodb-native/commit/3d3da4070b155d372477fd9b76ac9f1cd5e5011c))
* **NODE-6337:** implement client bulk write batching ([#4248](https://github.com/blink1073/node-mongodb-native/issues/4248)) ([d56e235](https://github.com/blink1073/node-mongodb-native/commit/d56e235cb7aa9d991cc1fb200c8a94e6a1b788fa))
* **NODE-6338:** implement client bulk write error handling ([#4262](https://github.com/blink1073/node-mongodb-native/issues/4262)) ([8def42d](https://github.com/blink1073/node-mongodb-native/commit/8def42ded5df4cb7d5ba1c65445d90042b1667c3))
* **NODE-6342:** support maxTimeMS for explain commands ([#4207](https://github.com/blink1073/node-mongodb-native/issues/4207)) ([20396e1](https://github.com/blink1073/node-mongodb-native/commit/20396e1bdba9c3fb89c789b1955f117ed28a3926))
* **NODE-6350:** add typescript support to client bulkWrite API ([#4257](https://github.com/blink1073/node-mongodb-native/issues/4257)) ([30c61f2](https://github.com/blink1073/node-mongodb-native/commit/30c61f2a926f1d8908b0800a4f9bb409e5d9581e))
* **NODE-6365:** pass through `allowPartialTrustChain` TLS flag ([#4228](https://github.com/blink1073/node-mongodb-native/issues/4228)) ([d6c147d](https://github.com/blink1073/node-mongodb-native/commit/d6c147d62a9aa96f0807e190190a06ed880df07f))
* **NODE-6387:** Add CSOT support to change streams ([#4256](https://github.com/blink1073/node-mongodb-native/issues/4256)) ([4588ff2](https://github.com/blink1073/node-mongodb-native/commit/4588ff2fa68cffb5f6769390d8c3eabe6926d483))
* **NODE-6389:** add support for timeoutMS in StateMachine.execute() ([#4243](https://github.com/blink1073/node-mongodb-native/issues/4243)) ([c55f965](https://github.com/blink1073/node-mongodb-native/commit/c55f96571ec4730bdd80c2a233cfaaf035ed688d))
* **NODE-6390:** Add timeoutMS support to auto encryption ([#4265](https://github.com/blink1073/node-mongodb-native/issues/4265)) ([55e08e7](https://github.com/blink1073/node-mongodb-native/commit/55e08e73194243e1ae4c6803429041e6b1d414e6))
* **NODE-6391:** Add timeoutMS support to explicit encryption ([#4269](https://github.com/blink1073/node-mongodb-native/issues/4269)) ([f745b99](https://github.com/blink1073/node-mongodb-native/commit/f745b99099c3d4d66e135af612ea341ed0d9750b))
* **NODE-6392:** add timeoutMS support to ClientEncryption helpers part 1 ([#4281](https://github.com/blink1073/node-mongodb-native/issues/4281)) ([e86f11e](https://github.com/blink1073/node-mongodb-native/commit/e86f11ed0cac1a32cb1b10d9ece3829827f4832b))
* **NODE-6403:** add CSOT support to client bulk write ([#4261](https://github.com/blink1073/node-mongodb-native/issues/4261)) ([365d63b](https://github.com/blink1073/node-mongodb-native/commit/365d63b46551620b92c6f8979679ea38c49ae7bd))
* **NODE-6409:** new errors for unacknowledged bulk writes ([#4276](https://github.com/blink1073/node-mongodb-native/issues/4276)) ([7fde8dd](https://github.com/blink1073/node-mongodb-native/commit/7fde8ddc869623e9df3ea7753a46cae8d6e3e9dd))
* **NODE-6419:** deprecate explain options API for find and aggregate ([#4271](https://github.com/blink1073/node-mongodb-native/issues/4271)) ([a473de9](https://github.com/blink1073/node-mongodb-native/commit/a473de95091a7d89c3cbe1c44222b04d3695387e))
* **NODE-6421:** add support for timeoutMS to explain helpers ([#4268](https://github.com/blink1073/node-mongodb-native/issues/4268)) ([5b2629b](https://github.com/blink1073/node-mongodb-native/commit/5b2629be4948b1f51f5085cc0ceef6818f8fe782))
* **NODE-6446:** deprecate legacy timeout options ([#4279](https://github.com/blink1073/node-mongodb-native/issues/4279)) ([c28608b](https://github.com/blink1073/node-mongodb-native/commit/c28608b8b19a8fbcfdc204a3fda982d52eea03a5))
* update bson to 6.2.0 ([#3898](https://github.com/blink1073/node-mongodb-native/issues/3898)) ([32b7176](https://github.com/blink1073/node-mongodb-native/commit/32b7176af6af4d6bd455200da64d0fde07ce0806))


### Bug Fixes

* **NODE-3681:** Typescript error in Collection.findOneAndModify UpdateFilter $currentDate ([#4047](https://github.com/blink1073/node-mongodb-native/issues/4047)) ([a8670a7](https://github.com/blink1073/node-mongodb-native/commit/a8670a76cd2746e8353504c100050b474d844f36))
* **NODE-4788:** use implementer Writable methods for GridFSBucketWriteStream  ([#3808](https://github.com/blink1073/node-mongodb-native/issues/3808)) ([7955610](https://github.com/blink1073/node-mongodb-native/commit/7955610c67eb500af683866aed631d06521345cc))
* **NODE-4863:** do not use RetryableWriteError for non-server errors ([#3914](https://github.com/blink1073/node-mongodb-native/issues/3914)) ([08c9fb4](https://github.com/blink1073/node-mongodb-native/commit/08c9fb4386736fad4a8df0174025e71971c1b6ff))
* **NODE-4936:** remove unsupported options from db.command and admin.command ([#3775](https://github.com/blink1073/node-mongodb-native/issues/3775)) ([52cd649](https://github.com/blink1073/node-mongodb-native/commit/52cd649caf2e64aef6d3984c5f2d24af03db4c51))
* **NODE-4977:** load snappy lazily ([#3726](https://github.com/blink1073/node-mongodb-native/issues/3726)) ([865e658](https://github.com/blink1073/node-mongodb-native/commit/865e658e7a341c8e9bd64e411bac2e9f5160820d))
* **NODE-5102:** listDatabases nameOnly setting is sent as NaN ([#3742](https://github.com/blink1073/node-mongodb-native/issues/3742)) ([b97132e](https://github.com/blink1073/node-mongodb-native/commit/b97132ea0d39d52192ee9bcf06e85d7e8db0c4ca))
* **NODE-5127:** implement reject kmsRequest on server close ([#3964](https://github.com/blink1073/node-mongodb-native/issues/3964)) ([568e05f](https://github.com/blink1073/node-mongodb-native/commit/568e05fdc3d78882e925e8e799aca6fb86c88295))
* **NODE-5201:** prevent warning when default value for deprecation option is used ([#3646](https://github.com/blink1073/node-mongodb-native/issues/3646)) ([e7f6e4e](https://github.com/blink1073/node-mongodb-native/commit/e7f6e4e34faa65678a34d14ad5b72aacb5dc8dc7))
* **NODE-5213:** `ChangeStream.tryNext()` should return TChange type ([#3649](https://github.com/blink1073/node-mongodb-native/issues/3649)) ([3b58ca1](https://github.com/blink1073/node-mongodb-native/commit/3b58ca1ec873bab3ed56b2de970f9c513a81c741))
* **NODE-5228:** remove unneeded fields from ConnectionPoolCreatedEvent.options ([#3772](https://github.com/blink1073/node-mongodb-native/issues/3772)) ([7a91714](https://github.com/blink1073/node-mongodb-native/commit/7a9171411e6afeb68d8611e15f49b872648dbc9c))
* **NODE-5249:** remove strict flag from create collection options ([#3677](https://github.com/blink1073/node-mongodb-native/issues/3677)) ([be8faaf](https://github.com/blink1073/node-mongodb-native/commit/be8faaf63996c70e54e9cccb130fd05f64651e34))
* **NODE-5260:** AWS Lambda metadata detection logic is too permissive ([#3663](https://github.com/blink1073/node-mongodb-native/issues/3663)) ([d74d3f9](https://github.com/blink1073/node-mongodb-native/commit/d74d3f9a1b7180542a7fda980e7b15f6f1460be0))
* **NODE-5289:** prevent scram auth from throwing TypeError if saslprep is not a function ([#3727](https://github.com/blink1073/node-mongodb-native/issues/3727)) ([e006347](https://github.com/blink1073/node-mongodb-native/commit/e0063477961bbd9c5ca34953e9afe554a1235581))
* **NODE-5296:** construct error messages for AggregateErrors in Node16+ ([#3682](https://github.com/blink1073/node-mongodb-native/issues/3682)) ([e03178e](https://github.com/blink1073/node-mongodb-native/commit/e03178ebc84e489e9058a72f576646a847470379))
* **NODE-5374:** do not apply cursor transform in Cursor.hasNext ([#3746](https://github.com/blink1073/node-mongodb-native/issues/3746)) ([0668cd8](https://github.com/blink1073/node-mongodb-native/commit/0668cd8d566acb02c9d8cc38bcffe51e1a9cd585))
* **NODE-5412:** drop aws sdk version to match node18 runtime ([#3809](https://github.com/blink1073/node-mongodb-native/issues/3809)) ([1e96e49](https://github.com/blink1073/node-mongodb-native/commit/1e96e49b607791d1c1517e65cf88f51821898b0b))
* **NODE-5496:** remove client-side collection and database name check validation ([#3873](https://github.com/blink1073/node-mongodb-native/issues/3873)) ([98550c6](https://github.com/blink1073/node-mongodb-native/commit/98550c6ad5b7c268707d3e9e2367ca56f71298ad))
* **NODE-5530:** make topology descriptions JSON stringifiable  ([#4070](https://github.com/blink1073/node-mongodb-native/issues/4070)) ([3a0e011](https://github.com/blink1073/node-mongodb-native/commit/3a0e01191be5836c4d41bd92c5cc64141b531dda))
* **NODE-5548:** ensure that tlsCertificateKeyFile maps to cert and key ([#3819](https://github.com/blink1073/node-mongodb-native/issues/3819)) ([a0955bd](https://github.com/blink1073/node-mongodb-native/commit/a0955bdf935113abbb28d7c7011abc04027be2b0))
* **NODE-5551:** set AWS region from environment variable for STSClient ([#3831](https://github.com/blink1073/node-mongodb-native/issues/3831)) ([e9a5079](https://github.com/blink1073/node-mongodb-native/commit/e9a50793143c53f5f70a720e17cf6683f56f7229))
* **NODE-5588:** recursive calls to next cause memory leak ([#3841](https://github.com/blink1073/node-mongodb-native/issues/3841)) ([9a8fdb2](https://github.com/blink1073/node-mongodb-native/commit/9a8fdb22853a7a84dfa8b8e87a6b5d808ae00b6e))
* **NODE-5592:** withTransaction return type ([#3846](https://github.com/blink1073/node-mongodb-native/issues/3846)) ([05d2725](https://github.com/blink1073/node-mongodb-native/commit/05d2725bf179e4c35ff3735856313bca062c77a8))
* **NODE-5609:** node driver omits base64 padding in sasl-continue command ([#3975](https://github.com/blink1073/node-mongodb-native/issues/3975)) ([b7d28d3](https://github.com/blink1073/node-mongodb-native/commit/b7d28d3135fa298d693aa22d2f1713054c5b0751))
* **NODE-5628:** bulkWriteResult.insertedIds does not filter out _ids that are not actually inserted ([#3867](https://github.com/blink1073/node-mongodb-native/issues/3867)) ([09f2a67](https://github.com/blink1073/node-mongodb-native/commit/09f2a6796b4f1ecec4880678e19375a07e446949))
* **NODE-5636:** generate _ids using pkFactory in bulk write operations ([#4025](https://github.com/blink1073/node-mongodb-native/issues/4025)) ([fbb5059](https://github.com/blink1073/node-mongodb-native/commit/fbb505906cc171ae01279025d42f6ea1c3e7e299))
* **NODE-5706:** make findOne() close implicit session to avoid memory leak ([#3897](https://github.com/blink1073/node-mongodb-native/issues/3897)) ([995d138](https://github.com/blink1073/node-mongodb-native/commit/995d13805d4d4e35eac41c2264979dd84b1e4dd3))
* **NODE-5709:** bump mongodb-connection-string-url to 3.0.0 ([#3909](https://github.com/blink1073/node-mongodb-native/issues/3909)) ([1c3dc02](https://github.com/blink1073/node-mongodb-native/commit/1c3dc0259c0758f3b16de3a696d2c40df32f8ad7))
* **NODE-5720:** on pre-4.4 sharded servers, the node driver uses `error.writeConcern.code` to determine retryability ([#4155](https://github.com/blink1073/node-mongodb-native/issues/4155)) ([b26c328](https://github.com/blink1073/node-mongodb-native/commit/b26c32800ecb2658a0d9c779bdb741aa06a629d0))
* **NODE-5745:** ignore Read/Write Concern in Atlas Search Index Helpers ([#4042](https://github.com/blink1073/node-mongodb-native/issues/4042)) ([67d7bab](https://github.com/blink1073/node-mongodb-native/commit/67d7bab434164fa9a81e22edde9339f89be91f65))
* **NODE-5749:** RTTPinger always sends legacy hello ([#3921](https://github.com/blink1073/node-mongodb-native/issues/3921)) ([ebbfb8a](https://github.com/blink1073/node-mongodb-native/commit/ebbfb8a0ba0a17fafa39f777a9546d0351ff66e2))
* **NODE-5765:** change type for countDocuments ([#3932](https://github.com/blink1073/node-mongodb-native/issues/3932)) ([22cae0f](https://github.com/blink1073/node-mongodb-native/commit/22cae0fbc0ad4043e27210577427870b8ec287f5))
* **NODE-5791:** type error with $addToSet in bulkWrite ([#3953](https://github.com/blink1073/node-mongodb-native/issues/3953)) ([b93d405](https://github.com/blink1073/node-mongodb-native/commit/b93d405275c3a8ce6b1eba0af335ffb2a309e34e))
* **NODE-5801:** use more specific key typing for multiple KMS provider support ([#4146](https://github.com/blink1073/node-mongodb-native/issues/4146)) ([465ffd9](https://github.com/blink1073/node-mongodb-native/commit/465ffd97974b40e2bf2608907455c00c58c59cff))
* **NODE-5818:** Add feature flagging to server selection logging ([#3974](https://github.com/blink1073/node-mongodb-native/issues/3974)) ([55203ef](https://github.com/blink1073/node-mongodb-native/commit/55203ef53d085518fd0acaf4b23d4a987cf6736d))
* **NODE-5839:** support for multibyte code-points in stringifyWithMaxLen ([#3979](https://github.com/blink1073/node-mongodb-native/issues/3979)) ([aed1cf0](https://github.com/blink1073/node-mongodb-native/commit/aed1cf0d2b1083e24997e49bfe7f5416e944466e))
* **NODE-5840:** heartbeat duration includes socket creation ([#3973](https://github.com/blink1073/node-mongodb-native/issues/3973)) ([a42039b](https://github.com/blink1073/node-mongodb-native/commit/a42039b9d03f1fc4d58f6edc641a839bc0364cd2))
* **NODE-5901:** propagate errors to transformed stream in cursor ([#3985](https://github.com/blink1073/node-mongodb-native/issues/3985)) ([ecfc615](https://github.com/blink1073/node-mongodb-native/commit/ecfc6157786360832d1afb4294d76f83a90a9d70))
* **NODE-5925:** driver throws error when non-read operation in a transaction has a ReadPreferenceMode other than 'primary' ([#4075](https://github.com/blink1073/node-mongodb-native/issues/4075)) ([39fc198](https://github.com/blink1073/node-mongodb-native/commit/39fc198b8fd2baed17c3aec223ca43094bb1c147))
* **NODE-5944:** make AWS session token optional ([#4002](https://github.com/blink1073/node-mongodb-native/issues/4002)) ([f26de76](https://github.com/blink1073/node-mongodb-native/commit/f26de764c7ee5034992ec5978175fc50f29fc690))
* **NODE-5971:** attach `v` to createIndexes command when `version` is specified ([#4043](https://github.com/blink1073/node-mongodb-native/issues/4043)) ([1879a04](https://github.com/blink1073/node-mongodb-native/commit/1879a04b9053e8c77c6957e415886c534fe9992b))
* **NODE-5981:** read preference not applied to commands properly ([#4010](https://github.com/blink1073/node-mongodb-native/issues/4010)) ([937c9c8](https://github.com/blink1073/node-mongodb-native/commit/937c9c890b6ad9be04823702b1b92b548ef4de9b))
* **NODE-5985:** throw Nodejs' certificate expired error when TLS fails to connect instead of `CERT_HAS_EXPIRED` ([#4014](https://github.com/blink1073/node-mongodb-native/issues/4014)) ([057c223](https://github.com/blink1073/node-mongodb-native/commit/057c223f13a0d129aa9efc01ba3c9b48271e7b97))
* **NODE-5993:** memory leak in the `Connection` class ([#4022](https://github.com/blink1073/node-mongodb-native/issues/4022)) ([69de253](https://github.com/blink1073/node-mongodb-native/commit/69de2537314fe25a5c3fa83f73235cfa7e7f729d))
* **NODE-5999:** Change TopologyDescription.error type to MongoError ([#4028](https://github.com/blink1073/node-mongodb-native/issues/4028)) ([30432e8](https://github.com/blink1073/node-mongodb-native/commit/30432e8664cb142e999159e5d06ceaaf14f51eb8))
* **NODE-6019:** indexExists always returns false when `full` is set to `true` ([#4034](https://github.com/blink1073/node-mongodb-native/issues/4034)) ([0ebc1ac](https://github.com/blink1073/node-mongodb-native/commit/0ebc1ac099a2ee869d8c1cb1c7632422c4e6a7ba))
* **NODE-6029:** update types for collection listing indexes ([#4072](https://github.com/blink1073/node-mongodb-native/issues/4072)) ([232bf3c](https://github.com/blink1073/node-mongodb-native/commit/232bf3cb9e41b717680ad0a5678bbc16d3cc243f))
* **NODE-6051:** only provide expected allowed keys to libmongocrypt after fetching aws kms credentials ([#4057](https://github.com/blink1073/node-mongodb-native/issues/4057)) ([c604e74](https://github.com/blink1073/node-mongodb-native/commit/c604e74e2ca0bcf827441558e40cecbaf9f4fe94))
* **NODE-6066:** ClusterTime.signature can be undefined ([#4069](https://github.com/blink1073/node-mongodb-native/issues/4069)) ([ce55ca9](https://github.com/blink1073/node-mongodb-native/commit/ce55ca9f5c7ea81058627b60e2cec5482d2be1f6))
* **NODE-6085:** add TS support for KMIP data key options ([#4128](https://github.com/blink1073/node-mongodb-native/issues/4128)) ([f790cc1](https://github.com/blink1073/node-mongodb-native/commit/f790cc181d87049e0018e1e5e859f90ee8156c0d))
* **NODE-6151:** MongoClient connect does not keep Node.js running ([#4101](https://github.com/blink1073/node-mongodb-native/issues/4101)) ([7e0d9e6](https://github.com/blink1073/node-mongodb-native/commit/7e0d9e689859e20ad0fd7aae047fc349e24355c9))
* **NODE-6165:** useBigInt64 causes compareTopologyVersion to throw ([#4109](https://github.com/blink1073/node-mongodb-native/issues/4109)) ([21b729b](https://github.com/blink1073/node-mongodb-native/commit/21b729b983e2ddbe1dd9cff31f996825a45ec4e0))
* **NODE-6171:** RTT set to zero when serverMonitoringMode=stream ([#4110](https://github.com/blink1073/node-mongodb-native/issues/4110)) ([7a7ec5b](https://github.com/blink1073/node-mongodb-native/commit/7a7ec5b95d0c38b377551c31d03130cd9f1882f6))
* **NODE-6241:** allow `Binary` as local KMS provider key ([#4160](https://github.com/blink1073/node-mongodb-native/issues/4160)) ([fb724eb](https://github.com/blink1073/node-mongodb-native/commit/fb724eb6441408ad7f93c50d146a12c9b64d8333))
* **NODE-6241:** allow Binary as local kms provider key for auto encryption ([#4165](https://github.com/blink1073/node-mongodb-native/issues/4165)) ([d85f827](https://github.com/blink1073/node-mongodb-native/commit/d85f827aca56603b5d7b64f853c190473be81b6f))
* **NODE-6242:** close becomes true after calling close when documents still remain ([#4161](https://github.com/blink1073/node-mongodb-native/issues/4161)) ([e3d70c3](https://github.com/blink1073/node-mongodb-native/commit/e3d70c3d224e1cd0888d79516c1b509921ac560d))
* **NODE-6259:** replace dynamically assigned length property with a static getter ([#4173](https://github.com/blink1073/node-mongodb-native/issues/4173)) ([320dde0](https://github.com/blink1073/node-mongodb-native/commit/320dde04aa1547dd838e7c790bb3432e2ca2bc19))
* **NODE-6276:** preserve top level error code MongoWriteConcernError ([#4183](https://github.com/blink1073/node-mongodb-native/issues/4183)) ([e902584](https://github.com/blink1073/node-mongodb-native/commit/e9025843e43bedb2326675184b6ce49b103e3c77))
* **NODE-6284:** make sparsity and trimFactor optional ([#4189](https://github.com/blink1073/node-mongodb-native/issues/4189)) ([8622545](https://github.com/blink1073/node-mongodb-native/commit/8622545c18d321ae17184cd43207652e454170fc))
* **NODE-6355:** respect utf8 validation options when iterating cursors ([#4214](https://github.com/blink1073/node-mongodb-native/issues/4214)) ([8bfe187](https://github.com/blink1073/node-mongodb-native/commit/8bfe18716197f58c025520da5d771b520e1b1350))
* **NODE-6362:** cache cursor deserialization options across deserialize calls ([#4221](https://github.com/blink1073/node-mongodb-native/issues/4221)) ([833eaa4](https://github.com/blink1073/node-mongodb-native/commit/833eaa41c5f379268be46408282b0c97323ea1bc))
* **NODE-6367:** enable mixed use of iteration APIs ([#4231](https://github.com/blink1073/node-mongodb-native/issues/4231)) ([08912c8](https://github.com/blink1073/node-mongodb-native/commit/08912c8a191937bdef921b4e9a4581b12ebf8b59))
* **NODE-6374:** MongoOperationTimeoutError inherits MongoRuntimeError ([#4237](https://github.com/blink1073/node-mongodb-native/issues/4237)) ([9fb896a](https://github.com/blink1073/node-mongodb-native/commit/9fb896a962a1bd5924453f0d2c43b0af8c01e4ba))
* **NODE-6394:** data events missed while awaiting drain ([#4249](https://github.com/blink1073/node-mongodb-native/issues/4249)) ([3f9d243](https://github.com/blink1073/node-mongodb-native/commit/3f9d24379afa1e1e953b77f46563fca5a26c8407))
* **NODE-6412:** read stale response from previously timed out connection ([#4273](https://github.com/blink1073/node-mongodb-native/issues/4273)) ([fd8f3bd](https://github.com/blink1073/node-mongodb-native/commit/fd8f3bd8f78960726a31d24afeb27d51c549f660))
* **NODE-6418:** change stream resumes infinitely after failed aggregates ([#4267](https://github.com/blink1073/node-mongodb-native/issues/4267)) ([6ecf198](https://github.com/blink1073/node-mongodb-native/commit/6ecf198f2e4805da42f651717c6e7f8182a8faeb))
* **NODE-6436:** only force majority write concern on commitTransaction retry ([#4284](https://github.com/blink1073/node-mongodb-native/issues/4284)) ([a7d1d43](https://github.com/blink1073/node-mongodb-native/commit/a7d1d43e96c6875dd325d17d87639c2338eb35f3))
* **NODE-6454:** use timeoutcontext for state machine execute() cursor options ([#4291](https://github.com/blink1073/node-mongodb-native/issues/4291)) ([5dd8ee5](https://github.com/blink1073/node-mongodb-native/commit/5dd8ee5632a306346406e8856e01ac21dedef813))
* **NODE-6523:** deleteMany in gridfs passes timeoutMS to predicate, not options ([#4319](https://github.com/blink1073/node-mongodb-native/issues/4319)) ([1965ed5](https://github.com/blink1073/node-mongodb-native/commit/1965ed51296bac9149ecb077b6cafd43150a3a07))


### Performance Improvements

* **NODE-5771:** improve new connection ([#3948](https://github.com/blink1073/node-mongodb-native/issues/3948)) ([a4776cf](https://github.com/blink1073/node-mongodb-native/commit/a4776cfe638c4e51cb690e43b941153d4f36a30a))
* **NODE-5854:** Conditional logger instantiation and precompute willLog perf fix ([#3984](https://github.com/blink1073/node-mongodb-native/issues/3984)) ([a63fbc2](https://github.com/blink1073/node-mongodb-native/commit/a63fbc2a98a2b0ed88bfe2cd5f59e9feee97820b))
* **NODE-5906:** optimize toArray to use batches ([#4171](https://github.com/blink1073/node-mongodb-native/issues/4171)) ([5565d50](https://github.com/blink1073/node-mongodb-native/commit/5565d5008812f03e9ff86a7b6326447ac5916244))
* **NODE-5928:** consolidate signal use and abort promise wrap ([#3992](https://github.com/blink1073/node-mongodb-native/issues/3992)) ([38742c2](https://github.com/blink1073/node-mongodb-native/commit/38742c2849d00e6a6070329b5c6a19704f40eb89))
* **NODE-5986:** parallelize SRV/TXT resolution ([#4012](https://github.com/blink1073/node-mongodb-native/issues/4012)) ([eab8f23](https://github.com/blink1073/node-mongodb-native/commit/eab8f2338622218a1e57121a31cad493f462931b))
* **NODE-6127:** move error construction into setTimeout callback ([#4094](https://github.com/blink1073/node-mongodb-native/issues/4094)) ([6abc074](https://github.com/blink1073/node-mongodb-native/commit/6abc074b3b1f2bbcc5d7252ab4cbfbd729fb4eb2))
