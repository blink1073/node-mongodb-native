...
## [7.0.0](https://github.com/blink1073/node-mongodb-native/compare/v6.14.2...v7.0.0) (2025-03-05)
...
* **NODE-5672:** support standardized logging ([#4387](https://github.com/blink1073/node-mongodb-native/issues/4387)) ([d1b2453](https://github.com/blink1073/node-mongodb-native/commit/d1b2453daeed50cd9edd5b8a631789a36429d6b2))
...
* **NODE-6258:** add signal support to find and aggregate ([#4364](https://github.com/blink1073/node-mongodb-native/issues/4364)) ([73def18](https://github.com/blink1073/node-mongodb-native/commit/73def18d3fa0aea1fdd5122088493f948addaa42))
...
* **NODE-6451:** retry SRV and TXT lookup for DNS timeout errors ([#4375](https://github.com/blink1073/node-mongodb-native/issues/4375)) ([fd902d3](https://github.com/blink1073/node-mongodb-native/commit/fd902d31d5cb65100f1c8b6f8811886b44ba19d5))
* **NODE-6551:** update bson to 6.10.0 ([#4329](https://github.com/blink1073/node-mongodb-native/issues/4329)) ([adb15fe](https://github.com/blink1073/node-mongodb-native/commit/adb15feb4e6e4e1ce0e4e35373b0b5cef8f5a320))
* **NODE-6593:** add support for zstd@2.x ([#4346](https://github.com/blink1073/node-mongodb-native/issues/4346)) ([ea8a33f](https://github.com/blink1073/node-mongodb-native/commit/ea8a33f1c34e93dd8048ba83edca3294e474ddf5))
* **NODE-6605:** add error message when invalidating primary ([#4340](https://github.com/blink1073/node-mongodb-native/issues/4340)) ([37613f1](https://github.com/blink1073/node-mongodb-native/commit/37613f1a726d330967012b0c007560db1cc79bd9))
* **NODE-6633:** MongoClient.close closes active cursors ([#4372](https://github.com/blink1073/node-mongodb-native/issues/4372)) ([654069f](https://github.com/blink1073/node-mongodb-native/commit/654069fc1750b6c3336f1002e3d3fb18bbc1451d))
* **NODE-6676:** add support for `nsType` in change stream create events ([#4431](https://github.com/blink1073/node-mongodb-native/issues/4431)) ([7800067](https://github.com/blink1073/node-mongodb-native/commit/7800067ad0ea4e24e3180fe264da4951b883e08d))
* **NODE-6773:** add support for $lookup with automatic encryption ([#4427](https://github.com/blink1073/node-mongodb-native/issues/4427)) ([965b21a](https://github.com/blink1073/node-mongodb-native/commit/965b21a20eff38c7fe7d9036f912b31c10e5ba21))
...
* **NODE-5225:** concurrent MongoClient.close() calls each attempt to close the client ([#4376](https://github.com/blink1073/node-mongodb-native/issues/4376)) ([9419af7](https://github.com/blink1073/node-mongodb-native/commit/9419af7b3bcbf134d0740c4282f83d1d5a717418))
...
* **NODE-6340:** OIDC reauth uses caches speculative auth result ([#4379](https://github.com/blink1073/node-mongodb-native/issues/4379)) ([8b2b7fd](https://github.com/blink1073/node-mongodb-native/commit/8b2b7fdc6366ee9b6b595daf074d6b88362df5e6))
...
* **NODE-6407:** use conversationId returned from server in saslContinue ([#4368](https://github.com/blink1073/node-mongodb-native/issues/4368)) ([fbefa6b](https://github.com/blink1073/node-mongodb-native/commit/fbefa6b6265bf3c5019e07626dd298c265ad4746))
...
* **NODE-6469:** pool is cleared before connection checkin on error ([#4296](https://github.com/blink1073/node-mongodb-native/issues/4296)) ([06a2e2c](https://github.com/blink1073/node-mongodb-native/commit/06a2e2ce45921dfe898eefaf1fbdd461c212d512))
...
* **NODE-6583:** upgrade to BSON v6.10.1 to remove internal unbounded type cache ([#4338](https://github.com/blink1073/node-mongodb-native/issues/4338)) ([249c279](https://github.com/blink1073/node-mongodb-native/commit/249c279ee21c0635ab22be10788ffcae52ad3bb5))
* **NODE-6600:** set object mode correctly for message chunking in SizedMessageTransform ([#4345](https://github.com/blink1073/node-mongodb-native/issues/4345)) ([5558573](https://github.com/blink1073/node-mongodb-native/commit/555857319605d72ce57c639166ce25f57739bf74))
* **NODE-6602:** only wrap errors from SOCKS in network errors ([#4347](https://github.com/blink1073/node-mongodb-native/issues/4347)) ([ed83f36](https://github.com/blink1073/node-mongodb-native/commit/ed83f36ce17e40f0faf4bbaaeab6fa3b7f90b10a))
* **NODE-6613:** Update error messages when primaries go stale ([#4397](https://github.com/blink1073/node-mongodb-native/issues/4397)) ([6528c8d](https://github.com/blink1073/node-mongodb-native/commit/6528c8db3acfb28fa58a7cd587703d3d40c065aa))
* **NODE-6690:** Remove extraneous Document in replaceOne return type ([#4383](https://github.com/blink1073/node-mongodb-native/issues/4383)) ([6c81d4e](https://github.com/blink1073/node-mongodb-native/commit/6c81d4e839589dd51cea0dca10d4163a13744c94))
* **NODE-6763:** pass WriteConcernOptions instead on WriteConcernSettings ([#4421](https://github.com/blink1073/node-mongodb-native/issues/4421)) ([26f15d7](https://github.com/blink1073/node-mongodb-native/commit/26f15d7edc109154b1064299299158a8327a73da))
* **NODE-6765:** FindOneAndUpdateOptions supports aggregation expressions ([#4423](https://github.com/blink1073/node-mongodb-native/issues/4423)) ([421ddeb](https://github.com/blink1073/node-mongodb-native/commit/421ddeb329169f47b567cbe432c39737551bd234))
* **NODE-6777:** update BSON to 6.10.3 ([#4428](https://github.com/blink1073/node-mongodb-native/issues/4428)) ([db5b9e0](https://github.com/blink1073/node-mongodb-native/commit/db5b9e00c3966019fc79d7b275e585f07c59144c))
* **NODE-6792:** use isUint8Array from driver's utils instead of util/types ([#4436](https://github.com/blink1073/node-mongodb-native/issues/4436)) ([dfe1fba](https://github.com/blink1073/node-mongodb-native/commit/dfe1fba777d89a53106487e38aaf5072978096b5))
* **NODE-6794:** revert `@aws-sdk/credential-providers` peer compatibility change ([#4437](https://github.com/blink1073/node-mongodb-native/issues/4437)) ([488c407](https://github.com/blink1073/node-mongodb-native/commit/488c4071632c29960de8955bfbefbaab163b45ba))
* **NODE-6801:** set token on connection from cache ([#4438](https://github.com/blink1073/node-mongodb-native/issues/4438)) ([cb13746](https://github.com/blink1073/node-mongodb-native/commit/cb1374649858ae2e0f3f3e109d7bf7e4bcd193c2))
* **NODE-6803:** kms proxy socket creates unhandled rejection ([#4444](https://github.com/blink1073/node-mongodb-native/issues/4444)) ([ed69cf9](https://github.com/blink1073/node-mongodb-native/commit/ed69cf914435ebc96c44b265704571e3d34629ef))
...
* **NODE-6452:** Optimize CommandStartedEvent and CommandSucceededEvent constructors ([#4371](https://github.com/blink1073/node-mongodb-native/issues/4371)) ([41b066b](https://github.com/blink1073/node-mongodb-native/commit/41b066b2b286879085b05a58c0486aa1d24303bc))
* **NODE-6525:** remove setPrototype and defineProperty from hot path ([#4321](https://github.com/blink1073/node-mongodb-native/issues/4321)) ([48ed47e](https://github.com/blink1073/node-mongodb-native/commit/48ed47ec192416e86762527cf3beabb4a634ac93))
* **NODE-6616:** shortcircuit logging ejson.stringify ([#4377](https://github.com/blink1073/node-mongodb-native/issues/4377)) ([c1bcf0d](https://github.com/blink1073/node-mongodb-native/commit/c1bcf0de991096975a5151bf780faa9803ddd765))
