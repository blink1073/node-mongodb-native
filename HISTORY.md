...
## [8.0.0](https://github.com/blink1073/node-mongodb-native/compare/v7.0.0...v8.0.0) (2026-01-30)


### ⚠ BREAKING CHANGES

* **NODE-7259:** use alphas of all supporting packages ([#4746](https://github.com/blink1073/node-mongodb-native/issues/4746))
* **NODE-5510:** dont filter change stream options ([#4723](https://github.com/blink1073/node-mongodb-native/issues/4723))
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/blink1073/node-mongodb-native/issues/4729))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/blink1073/node-mongodb-native/issues/4720))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/blink1073/node-mongodb-native/issues/4689))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/blink1073/node-mongodb-native/issues/4728))
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/blink1073/node-mongodb-native/issues/4724))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/blink1073/node-mongodb-native/issues/4717))
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/blink1073/node-mongodb-native/issues/4716))
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/blink1073/node-mongodb-native/issues/4719))
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/blink1073/node-mongodb-native/issues/4718))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/blink1073/node-mongodb-native/issues/4705))
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/blink1073/node-mongodb-native/issues/4711))
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/blink1073/node-mongodb-native/issues/4341))
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/blink1073/node-mongodb-native/issues/4696))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/blink1073/node-mongodb-native/issues/4668))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/blink1073/node-mongodb-native/issues/4656))
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/blink1073/node-mongodb-native/issues/4659))

### Features

* bump bson to 7.0.0-alpha.2 ([#4756](https://github.com/blink1073/node-mongodb-native/issues/4756)) ([9b34953](https://github.com/blink1073/node-mongodb-native/commit/9b3495359d4c87a26c33a2c2887c20d595e073e3))
...
* **NODE-4184:** don't throw on aggregate with write concern and explain ([#4718](https://github.com/blink1073/node-mongodb-native/issues/4718)) ([88e02a4](https://github.com/blink1073/node-mongodb-native/commit/88e02a41eaf69da100b2beeabc67a26406d4f2b7))
* **NODE-4243:** drop collection checks ns not found ([#4742](https://github.com/blink1073/node-mongodb-native/issues/4742)) ([a8d7c5f](https://github.com/blink1073/node-mongodb-native/commit/a8d7c5ff6c68ad57291641b2eb14cc27d91508ae))
* **NODE-4808:** remove support for stream() transform on cursors and change streams ([#4728](https://github.com/blink1073/node-mongodb-native/issues/4728)) ([1702987](https://github.com/blink1073/node-mongodb-native/commit/17029879712f9af4e941203deb636af612c02c62))
...
* **NODE-5393:** aws4 no longer required for AWS authentication ([#4824](https://github.com/blink1073/node-mongodb-native/issues/4824)) ([0f46db8](https://github.com/blink1073/node-mongodb-native/commit/0f46db8a6135178dbe2806bb1289870e8973f382))
* **NODE-5510:** dont filter change stream options ([#4723](https://github.com/blink1073/node-mongodb-native/issues/4723)) ([a2daf76](https://github.com/blink1073/node-mongodb-native/commit/a2daf764d0a0a0be1d60727fdbdbf99e897e60aa))
* **NODE-5545:** remove deprecated objects ([#4704](https://github.com/blink1073/node-mongodb-native/issues/4704)) ([cfbada6](https://github.com/blink1073/node-mongodb-native/commit/cfbada66ceb017bdb8fa1ff39257e1ab49ee9e25))
...
* **NODE-5994:** Remove metadata-related properties from public driver API ([#4716](https://github.com/blink1073/node-mongodb-native/issues/4716)) ([b59c5ce](https://github.com/blink1073/node-mongodb-native/commit/b59c5ce387714e3d3fc4eed20e882f4b56597dd0))
...
* **NODE-6065:** throw MongoRuntimeError instead of MissingDependencyError in crypto connection ([#4711](https://github.com/blink1073/node-mongodb-native/issues/4711)) ([ff229fa](https://github.com/blink1073/node-mongodb-native/commit/ff229fa8e4c906f5980ee4311c0eb0d883909934))
...
* **NODE-6296:** remove cursor default batch size of 1000 ([#4729](https://github.com/blink1073/node-mongodb-native/issues/4729)) ([f8a855f](https://github.com/blink1073/node-mongodb-native/commit/f8a855fcfcd0a2a0314c1eee89a8cf40dddebac1))
...
* **NODE-6334:** rename PoolRequstedRetry to PoolRequestedRetry ([#4696](https://github.com/blink1073/node-mongodb-native/issues/4696)) ([84db848](https://github.com/blink1073/node-mongodb-native/commit/84db84829fb41135d19bc5216137ef84a16a1960))
...
* **NODE-6377:** remove noResponse option ([#4724](https://github.com/blink1073/node-mongodb-native/issues/4724)) ([9e9059a](https://github.com/blink1073/node-mongodb-native/commit/9e9059a82f4886748cbecc8d36045f4fef6a4015))
...
* **NODE-6472:** findOne and find no longer keep open cursors ([#4580](https://github.com/blink1073/node-mongodb-native/issues/4580)) ([be7f808](https://github.com/blink1073/node-mongodb-native/commit/be7f808c3ff0d894906ec187de98e159ebb7b18d))
* **NODE-6473:** remove MONGODB-CR auth ([#4717](https://github.com/blink1073/node-mongodb-native/issues/4717)) ([9a1bc65](https://github.com/blink1073/node-mongodb-native/commit/9a1bc65893640f56b25049243ac94fc3dab35c8a))
...
* **NODE-6584:** improve typing for filepaths in AutoEncryptionOptions ([#4341](https://github.com/blink1073/node-mongodb-native/issues/4341)) ([dab4c7c](https://github.com/blink1073/node-mongodb-native/commit/dab4c7c8279ac1112d99d7ceca505632a45d0787))
...
* **NODE-6883:** allow rawData option on time series collections ([#4642](https://github.com/blink1073/node-mongodb-native/issues/4642)) ([0fa3cd4](https://github.com/blink1073/node-mongodb-native/commit/0fa3cd4e82b2b0d28a10bebca1dded2aa9324708))
...
* **NODE-6988:** require aws sdk for aws auth ([#4659](https://github.com/blink1073/node-mongodb-native/issues/4659)) ([b7c6750](https://github.com/blink1073/node-mongodb-native/commit/b7c6750771e0a578e7f2ce6a8b9192ee7e76e8d3))
...
* **NODE-7016:** remove `beta` namespace and move resource management into driver ([#4719](https://github.com/blink1073/node-mongodb-native/issues/4719)) ([fb2824f](https://github.com/blink1073/node-mongodb-native/commit/fb2824ffd503d0b8d580df3ee51bf40cc51f53e0))
* **NODE-7020:** remove ping on connect ([#4607](https://github.com/blink1073/node-mongodb-native/issues/4607)) ([3d296b7](https://github.com/blink1073/node-mongodb-native/commit/3d296b7d94810c3bc29153ffc3c8795f02699dd4))
* **NODE-7043, NODE-7217:** adopt mongodb-client-encryption v7 ([#4705](https://github.com/blink1073/node-mongodb-native/issues/4705)) ([3f7196e](https://github.com/blink1073/node-mongodb-native/commit/3f7196eb346925f2f6c016abfd18f030de25c911))
* **NODE-7046:** remove AWS uri/options support ([#4689](https://github.com/blink1073/node-mongodb-native/issues/4689)) ([d14ac3f](https://github.com/blink1073/node-mongodb-native/commit/d14ac3f66a7d17ece094568355a8e5b130c9926a))
* **NODE-7047:** use custom credential provider first after URI ([#4656](https://github.com/blink1073/node-mongodb-native/issues/4656)) ([2a47bbb](https://github.com/blink1073/node-mongodb-native/commit/2a47bbbf03ec54509d93f925d0747378e3de80ed))
...
* **NODE-7059, NODE-7008:** add support for text queries for QE string fields ([#4597](https://github.com/blink1073/node-mongodb-native/issues/4597)) ([e4492f3](https://github.com/blink1073/node-mongodb-native/commit/e4492f3ff260a440ab4b2cb64ca90a68f9cf6fd5))
* **NODE-7121:** prevent connection churn on backpressure errors when establishing connections ([#4800](https://github.com/blink1073/node-mongodb-native/issues/4800)) ([4cb2b87](https://github.com/blink1073/node-mongodb-native/commit/4cb2b87537536461dc2f5cd9f0a8a56ad193cb13))
* **NODE-7122:** exponential backoff between retries in convenient transaction API ([#4765](https://github.com/blink1073/node-mongodb-native/issues/4765)) ([e70fdc9](https://github.com/blink1073/node-mongodb-native/commit/e70fdc981dc2bdc0d3c12515b2eecc214d8f3ce4))
* **NODE-7125:** add db and client properties to collection and database objects ([#4640](https://github.com/blink1073/node-mongodb-native/issues/4640)) ([3469f86](https://github.com/blink1073/node-mongodb-native/commit/3469f86816e4b583a12de29d76b19823a3ad25ef))
* **NODE-7134:** allow hint with unacknowledged writes for delete, update and findAndModify commands ([#4647](https://github.com/blink1073/node-mongodb-native/issues/4647)) ([82d6ce6](https://github.com/blink1073/node-mongodb-native/commit/82d6ce6a6dbbf6d823f02c8d183fc1d45f0d1560))
* **NODE-7139:** remove pre-4.2 logic and deprecate dead code ([#4657](https://github.com/blink1073/node-mongodb-native/issues/4657)) ([14303bc](https://github.com/blink1073/node-mongodb-native/commit/14303bc810c1aa069d440ac3cd45bff354dc51aa))
* **NODE-7140:** deprecate driver info options ([#4654](https://github.com/blink1073/node-mongodb-native/issues/4654)) ([b813c85](https://github.com/blink1073/node-mongodb-native/commit/b813c85813c7c86b84aed1cdde69fc3e06856892))
* **NODE-7150:** update peer dependency matrix for 3rd party peer deps ([#4720](https://github.com/blink1073/node-mongodb-native/issues/4720)) ([0451dae](https://github.com/blink1073/node-mongodb-native/commit/0451dae9df3eaf3a0f85ac6e783a1da6bb31d1d3))
* **NODE-7157:** deprecate `retryWrites` in `CommandOperationOptions` ([#4661](https://github.com/blink1073/node-mongodb-native/issues/4661)) ([620972d](https://github.com/blink1073/node-mongodb-native/commit/620972df28f57aae1eb67dd2d3a49f8cf48f7262))
* **NODE-7174:** drop support for Node16 and Node18 ([#4668](https://github.com/blink1073/node-mongodb-native/issues/4668)) ([a576b7d](https://github.com/blink1073/node-mongodb-native/commit/a576b7d3a8210f0544c3814b130ea21585ea1f9f))
* **NODE-7223:** run checkout on connect regardless of credentials ([#4715](https://github.com/blink1073/node-mongodb-native/issues/4715)) ([c5f74ab](https://github.com/blink1073/node-mongodb-native/commit/c5f74abe27acd8661f17046b1740ac74de1be082))
* **NODE-7259:** use alphas of all supporting packages ([#4746](https://github.com/blink1073/node-mongodb-native/issues/4746)) ([e1ea14c](https://github.com/blink1073/node-mongodb-native/commit/e1ea14ce80aece9d1cdd2e2c16ac1e5f4d9eff98))
* **NODE-7260:** update bson alpha to latest ([#4748](https://github.com/blink1073/node-mongodb-native/issues/4748)) ([4e88559](https://github.com/blink1073/node-mongodb-native/commit/4e88559e8785973dc2124a54d5e850a00616bb16))
* **NODE-7304:** remove usages in src of promisify ([#4799](https://github.com/blink1073/node-mongodb-native/issues/4799)) ([761b9bf](https://github.com/blink1073/node-mongodb-native/commit/761b9bfab8dfc8e3e7e311731d7a5cda1285bc6c))
* **NODE-7306:** Replace global process with import node:process ([#4820](https://github.com/blink1073/node-mongodb-native/issues/4820)) ([cc503cb](https://github.com/blink1073/node-mongodb-native/commit/cc503cb9810e2dbde0862fd8c8daa8ee613ef7b1))
* **NODE-7310:** Replace process.arch with os.arch() ([#4823](https://github.com/blink1073/node-mongodb-native/issues/4823)) ([f0af829](https://github.com/blink1073/node-mongodb-native/commit/f0af829f1a6fdf8cc0b070a327682f6299b747f1))
* **NODE-7311:** Replace process.platform with os.platform() ([#4822](https://github.com/blink1073/node-mongodb-native/issues/4822)) ([c58ca1f](https://github.com/blink1073/node-mongodb-native/commit/c58ca1f9d6a177470e58098ca1874174607c35c8))
* **NODE-7317:** use BSON.NumberUtils to determine endianness ([#4808](https://github.com/blink1073/node-mongodb-native/issues/4808)) ([4e9467e](https://github.com/blink1073/node-mongodb-native/commit/4e9467e8ab9ccbcf6eb47156d84ac538c5e3f6ea))
* **NODE-7319:** update allowed hosts list with *.mongo.com ([#4802](https://github.com/blink1073/node-mongodb-native/issues/4802)) ([bfb7160](https://github.com/blink1073/node-mongodb-native/commit/bfb71603fdfaaaebf418a3064f293d2c95697865))
* **NODE-7330:** deprecate RenameCollectionOptions.new_collection ([#4815](https://github.com/blink1073/node-mongodb-native/issues/4815)) ([a96fa26](https://github.com/blink1073/node-mongodb-native/commit/a96fa26dea3060828af747f0f2974229018de730))
* **NODE-7333:** add support for deprioritized servers to all topologies  ([#4821](https://github.com/blink1073/node-mongodb-native/issues/4821)) ([a4211e7](https://github.com/blink1073/node-mongodb-native/commit/a4211e77a30450ca8b162cbe3eec9f3759d3f517))


### Bug Fixes

* **NODE-4763:** cache `resumeToken` in `ChangeStream.tryNext()` ([#4636](https://github.com/blink1073/node-mongodb-native/issues/4636)) ([8331a93](https://github.com/blink1073/node-mongodb-native/commit/8331a939c2f3d6833486ca3ec45cd77603cf3fa9))
...
* **NODE-6858:** treat MongoServerSelectionError as a resumable error for Change Streams ([#4653](https://github.com/blink1073/node-mongodb-native/issues/4653)) ([c6d64e7](https://github.com/blink1073/node-mongodb-native/commit/c6d64e71b010dbf2bc0dc634df12d7a03bd12da6))
...
* **NODE-7067:** Wrap socket write in a try/catch to ensure errors can be properly wrapped ([#4759](https://github.com/blink1073/node-mongodb-native/issues/4759)) ([66c18b7](https://github.com/blink1073/node-mongodb-native/commit/66c18b7ee948e43847b324b25b552c2ff9ca851c))
* **NODE-7138:** prevent duplicate metadata from being appended to handshake metadata ([#4651](https://github.com/blink1073/node-mongodb-native/issues/4651)) ([05c230c](https://github.com/blink1073/node-mongodb-native/commit/05c230cb1b0cc5831983ad2fc8f84200a35da63d))
* **NODE-7232:** only send endSessions during client close if the topology supports sessions ([#4722](https://github.com/blink1073/node-mongodb-native/issues/4722)) ([cc85ebf](https://github.com/blink1073/node-mongodb-native/commit/cc85ebf246b20e0bae59e1bdcdf0f9c74ea01979))
* **NODE-7247:** clarify #rewrapManyDataKey() parameter types ([#4760](https://github.com/blink1073/node-mongodb-native/issues/4760)) ([cb522bf](https://github.com/blink1073/node-mongodb-native/commit/cb522bfd0c45086a821e4918c0f1af33c68cfa7a))
* **NODE-7270:** remove extra BSONType file in docs/Next/variables ([#4754](https://github.com/blink1073/node-mongodb-native/issues/4754)) ([df3aaaa](https://github.com/blink1073/node-mongodb-native/commit/df3aaaa3480d19f82b4a0c265e4b9c4b6a69a94b))
* **NODE-7290:** use valueof for error code check ([#4791](https://github.com/blink1073/node-mongodb-native/issues/4791)) ([1cc3d1c](https://github.com/blink1073/node-mongodb-native/commit/1cc3d1c952274b2fc18ffd4898978af97f76b554))
* **NODE-7298:** ensure commonWireVersion is computed from server maxWireVersion ([#4805](https://github.com/blink1073/node-mongodb-native/issues/4805)) ([2b2366d](https://github.com/blink1073/node-mongodb-native/commit/2b2366dd18a76bd9e0b36b9911af6a0a317926c3))
* **NODE-7307:** Replace node:process.hrtime() with performance.now() ([#4816](https://github.com/blink1073/node-mongodb-native/issues/4816)) ([ae2e037](https://github.com/blink1073/node-mongodb-native/commit/ae2e037e896fbc673061da49a7c45743ae145651))
* **NODE-7308:** replace process.nextTick with queueMicrotask  ([#4817](https://github.com/blink1073/node-mongodb-native/issues/4817)) ([b1b6e81](https://github.com/blink1073/node-mongodb-native/commit/b1b6e81168a2cb6a2cc089d8c3cb83df1405931f))
