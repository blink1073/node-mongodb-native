...
## [6.0.0](https://github.com/blink1073/node-mongodb-native/compare/v5.9.2...v6.0.0) (2024-11-11)


### ⚠ BREAKING CHANGES

* **NODE-5016:** compile ts with target es2020 ([#3545](https://github.com/blink1073/node-mongodb-native/issues/3545))
* **NODE-4522:** remove callback support ([#3499](https://github.com/blink1073/node-mongodb-native/issues/3499))
* **NODE-4817:** remove legacy logger ([#3518](https://github.com/blink1073/node-mongodb-native/issues/3518))
* **NODE-4867:** adopt BSON v5 ([#3490](https://github.com/blink1073/node-mongodb-native/issues/3490))
* **NODE-4738:** remove dot notation support by default ([#3520](https://github.com/blink1073/node-mongodb-native/issues/3520))
* **NODE-4950:** remove bson-ext import ([#3523](https://github.com/blink1073/node-mongodb-native/issues/3523))
* **NODE-4756:** ok 1 with write concern failure event changes ([#3525](https://github.com/blink1073/node-mongodb-native/issues/3525))
* **NODE-4034:** make internal bulk result private ([#3515](https://github.com/blink1073/node-mongodb-native/issues/3515))
* **NODE-4751:** drop support for client encryption < 2.3.0 ([#3521](https://github.com/blink1073/node-mongodb-native/issues/3521))
* **NODE-4684:** remove collection insert, update, remove methods ([#3500](https://github.com/blink1073/node-mongodb-native/issues/3500))
* **NODE-4924:** remove mapReduce collection helper ([#3511](https://github.com/blink1073/node-mongodb-native/issues/3511))
* **NODE-4925:** remove deprecated options and types ([#3513](https://github.com/blink1073/node-mongodb-native/issues/3513))
* **NODE-3818:** remove slaveOk options ([#3503](https://github.com/blink1073/node-mongodb-native/issues/3503))
* **NODE-3695:** remove lastop and optime from bulk result ([#3504](https://github.com/blink1073/node-mongodb-native/issues/3504))
* **NODE-3489:** remove cursor close options ([#3505](https://github.com/blink1073/node-mongodb-native/issues/3505))
* **NODE-4598:** close cursor on early loop break ([#3502](https://github.com/blink1073/node-mongodb-native/issues/3502))
* **NODE-3482:** remove unref ([#3494](https://github.com/blink1073/node-mongodb-native/issues/3494))
* **NODE-4521:** remove custom promise library support ([#3498](https://github.com/blink1073/node-mongodb-native/issues/3498))
* **NODE-4898:** aws credential providers now optional peerDependency ([#3497](https://github.com/blink1073/node-mongodb-native/issues/3497))
* **NODE-4436:** update minimum supported node version ([#3496](https://github.com/blink1073/node-mongodb-native/issues/3496))
* **NODE-4899:** support only snappy 7 or later ([#3491](https://github.com/blink1073/node-mongodb-native/issues/3491))

### Features

* **NODE-1837:** add zstd compression option ([#3237](https://github.com/blink1073/node-mongodb-native/issues/3237)) ([1261432](https://github.com/blink1073/node-mongodb-native/commit/12614320d34478693ad3821e75f7b15da44c2230))
* **NODE-2993:** implement maxConnecting ([#3255](https://github.com/blink1073/node-mongodb-native/issues/3255)) ([c9d3816](https://github.com/blink1073/node-mongodb-native/commit/c9d38163199d5cb0974d2c497e80e4c317927f6e))
* **NODE-3255:** add minPoolSizeCheckIntervalMS option to connection pool ([#3429](https://github.com/blink1073/node-mongodb-native/issues/3429)) ([5f34ad0](https://github.com/blink1073/node-mongodb-native/commit/5f34ad07220bfbaf3b9fb6da2fdf67b78b92cb9e))
...
* **NODE-3482:** remove unref ([#3494](https://github.com/blink1073/node-mongodb-native/issues/3494)) ([556812f](https://github.com/blink1073/node-mongodb-native/commit/556812f2d879fc6f5585b26f6af1db6f08a19b97))
* **NODE-3489:** remove cursor close options ([#3505](https://github.com/blink1073/node-mongodb-native/issues/3505)) ([88c03a1](https://github.com/blink1073/node-mongodb-native/commit/88c03a127adb462047d3b5ecbcb3d390fa8f6c13))
* **NODE-3517:** improve index spec handling and type definitions ([#3315](https://github.com/blink1073/node-mongodb-native/issues/3315)) ([0754bf9](https://github.com/blink1073/node-mongodb-native/commit/0754bf9c322b3a6e0200968ed31b95dd39e76c4b))
* **NODE-3651:** add hashed index type ([#3432](https://github.com/blink1073/node-mongodb-native/issues/3432)) ([f6b56a1](https://github.com/blink1073/node-mongodb-native/commit/f6b56a17bfd707bb8f42c22af09915dc8b4e6e68))
* **NODE-3695:** remove lastop and optime from bulk result ([#3504](https://github.com/blink1073/node-mongodb-native/issues/3504)) ([8900d40](https://github.com/blink1073/node-mongodb-native/commit/8900d40eaa0476ea672b5d01089229453cacca58))
* **NODE-3750:** make maxConnecting configurable ([#3261](https://github.com/blink1073/node-mongodb-native/issues/3261)) ([ee41447](https://github.com/blink1073/node-mongodb-native/commit/ee414476aa839e364bce6b26ab47859be1b99307))
* **NODE-3818:** remove slaveOk options ([#3503](https://github.com/blink1073/node-mongodb-native/issues/3503)) ([2e28009](https://github.com/blink1073/node-mongodb-native/commit/2e28009892cca6db9564fba9822a321f7900f44b))
* **NODE-3875:** support recursive schema types ([#3433](https://github.com/blink1073/node-mongodb-native/issues/3433)) ([26bce4a](https://github.com/blink1073/node-mongodb-native/commit/26bce4a8debb65df5a42dc8599e886c9c83de10d))
* **NODE-3938:** Add support for pre/post images in change streams ([#3250](https://github.com/blink1073/node-mongodb-native/issues/3250)) ([981465c](https://github.com/blink1073/node-mongodb-native/commit/981465c35e9c104ef3e4de3d9c5d033337220cf7))
* **NODE-4034:** make internal bulk result private ([#3515](https://github.com/blink1073/node-mongodb-native/issues/3515)) ([ebac1f5](https://github.com/blink1073/node-mongodb-native/commit/ebac1f50fafb4b3a229ac60d987d383ed1326803))
* **NODE-4059:** ChangeStreamDocument not fully typed to specification ([#3191](https://github.com/blink1073/node-mongodb-native/issues/3191)) ([8b24212](https://github.com/blink1073/node-mongodb-native/commit/8b2421283b97249bd733d8c756c44dc6540df469))
* **NODE-4078:** allow comment with estimated doc count ([#3301](https://github.com/blink1073/node-mongodb-native/issues/3301)) ([bed1fe3](https://github.com/blink1073/node-mongodb-native/commit/bed1fe3cc070861b4566ff494512d78a5b1d37a8))
* **NODE-4079:** estimated document count uses count ([#3244](https://github.com/blink1073/node-mongodb-native/issues/3244)) ([a752e75](https://github.com/blink1073/node-mongodb-native/commit/a752e75a26025e56ab9e47e4da59e1e6ccee511f))
* **NODE-4081:** fix and deprecate change stream resume options ([#3270](https://github.com/blink1073/node-mongodb-native/issues/3270)) ([47adfb3](https://github.com/blink1073/node-mongodb-native/commit/47adfb3db6e38e153e8e78f2b6e4463754775cc6))
* **NODE-4139:** streaming protocol message changes ([#3256](https://github.com/blink1073/node-mongodb-native/issues/3256)) ([4b9ad77](https://github.com/blink1073/node-mongodb-native/commit/4b9ad777fb78cc37b71dece0e647593950efccb8))
* **NODE-4185:** Allow opting out of disk use on cursor builder ([#3230](https://github.com/blink1073/node-mongodb-native/issues/3230)) ([d216725](https://github.com/blink1073/node-mongodb-native/commit/d216725fd7557811170abea2ed06856e5940395b))
* **NODE-4189:** Add support for clustered collections ([#3229](https://github.com/blink1073/node-mongodb-native/issues/3229)) ([79a917b](https://github.com/blink1073/node-mongodb-native/commit/79a917b3d6426f681f0ba55243d29c92a7254dcc))
* **NODE-4192:** make MongoClient.connect optional ([#3232](https://github.com/blink1073/node-mongodb-native/issues/3232)) ([a2359e4](https://github.com/blink1073/node-mongodb-native/commit/a2359e43d7a59acf69785104b5f6e6c1516a5e27))
* **NODE-4196:** add support for showExpandedEvents in change streams ([#3254](https://github.com/blink1073/node-mongodb-native/issues/3254)) ([9c1782e](https://github.com/blink1073/node-mongodb-native/commit/9c1782e23c7d63dc45d9242e451953fb2ef294a6))
* **NODE-4202:** add FLE 2 behavior for create/drop collection ([#3218](https://github.com/blink1073/node-mongodb-native/issues/3218)) ([6d3947b](https://github.com/blink1073/node-mongodb-native/commit/6d3947bf701c6953f6e4dc1ae8003d6d305bb3b1))
* **NODE-4229:** bump maxWireVersion to 17 ([#3265](https://github.com/blink1073/node-mongodb-native/issues/3265)) ([d13cec2](https://github.com/blink1073/node-mongodb-native/commit/d13cec2e1ae1da2983218275aefccc48d0cfd260))
* **NODE-4267:** support nested fields in type completion for UpdateFilter ([#3259](https://github.com/blink1073/node-mongodb-native/issues/3259)) ([1a9a44c](https://github.com/blink1073/node-mongodb-native/commit/1a9a44cf91847258cf33454d6d3c71c3ba002507))
* **NODE-4294:** mark queryable encryption options beta ([#3300](https://github.com/blink1073/node-mongodb-native/issues/3300)) ([4c07bbb](https://github.com/blink1073/node-mongodb-native/commit/4c07bbbed939516e50369aac44b170ec02ceeba3))
* **NODE-4301:** remove shared lib experimental tags ([#3298](https://github.com/blink1073/node-mongodb-native/issues/3298)) ([3976783](https://github.com/blink1073/node-mongodb-native/commit/3976783331114ec52740982fea3b82b789581ed5))
* **NODE-4336:** deprecate old write concern options and add missing writeConcern to MongoClientOptions ([#3340](https://github.com/blink1073/node-mongodb-native/issues/3340)) ([d2b6ad8](https://github.com/blink1073/node-mongodb-native/commit/d2b6ad8da39d2dd5c01ee7e7ad9622ad65e515f0))
* **NODE-4385:** add cmap pool pausing functionality ([#3321](https://github.com/blink1073/node-mongodb-native/issues/3321)) ([335ee55](https://github.com/blink1073/node-mongodb-native/commit/335ee55d04d4f7f5a6a0dfb06884dd318dc0fc2d))
* **NODE-4436:** update minimum supported node version ([#3496](https://github.com/blink1073/node-mongodb-native/issues/3496)) ([cca5362](https://github.com/blink1073/node-mongodb-native/commit/cca53621a00dcebc224908ce050b37862fda0f12))
* **NODE-4484:** add experimental support for disambiguatedPaths in change stream documents ([#3365](https://github.com/blink1073/node-mongodb-native/issues/3365)) ([846365a](https://github.com/blink1073/node-mongodb-native/commit/846365a5ef58acb53480fbd5a7e0e83cbfed2a3e))
* **NODE-4503:** throw original error when server attaches NoWritesPerformed label ([#3441](https://github.com/blink1073/node-mongodb-native/issues/3441)) ([a7dab96](https://github.com/blink1073/node-mongodb-native/commit/a7dab96cf0a148bc411eb943d4433ba659451117))
* **NODE-4509:** send 1 with hello commands ([#3508](https://github.com/blink1073/node-mongodb-native/issues/3508)) ([cc8ea1d](https://github.com/blink1073/node-mongodb-native/commit/cc8ea1dbf60b4a0484f4acdc107391d0449d70c8))
* **NODE-4519:** deprecate promiseLibrary and PromiseProvider ([#3403](https://github.com/blink1073/node-mongodb-native/issues/3403)) ([5c322b6](https://github.com/blink1073/node-mongodb-native/commit/5c322b647fb878534f612329e1ac99daad6405d2))
* **NODE-4521:** remove custom promise library support ([#3498](https://github.com/blink1073/node-mongodb-native/issues/3498)) ([af36ebb](https://github.com/blink1073/node-mongodb-native/commit/af36ebbbe231722ed55b53d3dece5567e281587a))
* **NODE-4522:** remove callback support ([#3499](https://github.com/blink1073/node-mongodb-native/issues/3499)) ([52853ff](https://github.com/blink1073/node-mongodb-native/commit/52853fff46ca01454f62b164ec3c7465c1fc0279))
* **NODE-4547:** mark all callback APIs as deprecated ([#3388](https://github.com/blink1073/node-mongodb-native/issues/3388)) ([a983f14](https://github.com/blink1073/node-mongodb-native/commit/a983f147776e38a8c09a063120f64d5053619842))
* **NODE-4548:** export ChangeStream class from top-level ([#3357](https://github.com/blink1073/node-mongodb-native/issues/3357)) ([48f295a](https://github.com/blink1073/node-mongodb-native/commit/48f295a2ab38e284c9437300aab35a4678650c87))
* **NODE-4598:** close cursor on early loop break ([#3502](https://github.com/blink1073/node-mongodb-native/issues/3502)) ([30c0aee](https://github.com/blink1073/node-mongodb-native/commit/30c0aeeb99f7ff21d990dcf0dfa9de677acb7905))
* **NODE-4607:** add exports needed by legacy client ([#3396](https://github.com/blink1073/node-mongodb-native/issues/3396)) ([972f760](https://github.com/blink1073/node-mongodb-native/commit/972f760947330d11895579acc63b509fcaac893c))
* **NODE-4634:** add support for bulk FindOperators.hint() ([#3408](https://github.com/blink1073/node-mongodb-native/issues/3408)) ([8758890](https://github.com/blink1073/node-mongodb-native/commit/87588901c620f3cf350acf188726c45a4acf30c4))
* **NODE-4650:** handle handshake errors with SDAM ([#3426](https://github.com/blink1073/node-mongodb-native/issues/3426)) ([cbe7533](https://github.com/blink1073/node-mongodb-native/commit/cbe75332d767a921551d71ea5725fac250906b00))
* **NODE-4681:** deprecate modify result ([#3459](https://github.com/blink1073/node-mongodb-native/issues/3459)) ([6a8776c](https://github.com/blink1073/node-mongodb-native/commit/6a8776c32c8c63beb7871458413baadd9e126efa))
* **NODE-4683:** make ChangeStream an async iterable ([#3454](https://github.com/blink1073/node-mongodb-native/issues/3454)) ([df8d9a4](https://github.com/blink1073/node-mongodb-native/commit/df8d9a4f2bb68f747ecb2b4d88a9137ca4f6ecb4))
* **NODE-4684:** remove collection insert, update, remove methods ([#3500](https://github.com/blink1073/node-mongodb-native/issues/3500)) ([14427d1](https://github.com/blink1073/node-mongodb-native/commit/14427d1b07518cbb3ca36dfbd24f02cd2e486835))
* **NODE-4691:** interrupt in-flight operations on heartbeat failure ([#3457](https://github.com/blink1073/node-mongodb-native/issues/3457)) ([e641bd4](https://github.com/blink1073/node-mongodb-native/commit/e641bd44ef39d64b8b572e7a8ab6bfc71a2b4bed))
...
* **NODE-4721:** add aws-sdk as optional dependency ([#3446](https://github.com/blink1073/node-mongodb-native/issues/3446)) ([b879cb5](https://github.com/blink1073/node-mongodb-native/commit/b879cb590e1c1880d12522aea2a3ac3a66e6031d))
* **NODE-4733:** deprecate result and getLastOp ([#3458](https://github.com/blink1073/node-mongodb-native/issues/3458)) ([a143d3b](https://github.com/blink1073/node-mongodb-native/commit/a143d3bc6768076fe65368feac0726ca201d4bb0))
* **NODE-4738:** remove dot notation support by default ([#3520](https://github.com/blink1073/node-mongodb-native/issues/3520)) ([26145df](https://github.com/blink1073/node-mongodb-native/commit/26145dfcca55f889e6f03a4e38f8af21039f8795))
* **NODE-4751:** drop support for client encryption &lt; 2.3.0 ([#3521](https://github.com/blink1073/node-mongodb-native/issues/3521)) ([3dae6da](https://github.com/blink1073/node-mongodb-native/commit/3dae6da24cba749597e1e8c378423c071847c5f6))
* **NODE-4756:** ok 1 with write concern failure event changes ([#3525](https://github.com/blink1073/node-mongodb-native/issues/3525)) ([fee783c](https://github.com/blink1073/node-mongodb-native/commit/fee783cdafab02d8a022d08a9c3299e2da809d74))
* **NODE-4757:** deprecate unused PipeOptions ([#3466](https://github.com/blink1073/node-mongodb-native/issues/3466)) ([1a5e619](https://github.com/blink1073/node-mongodb-native/commit/1a5e619f13c3112d75f7b40d2e2cbde027de7f0b))
* **NODE-4767:** Change abstract cursor return type ([#3531](https://github.com/blink1073/node-mongodb-native/issues/3531)) ([410ef30](https://github.com/blink1073/node-mongodb-native/commit/410ef3030ec0de03b9f9888ad66ff66b6229e302))
...
* **NODE-4809:** deprecate the existing logger ([#3464](https://github.com/blink1073/node-mongodb-native/issues/3464)) ([1eea4f0](https://github.com/blink1073/node-mongodb-native/commit/1eea4f0f5821bb44c86f653d5a3a6c022a5cf55b))
* **NODE-4810:** define the new Logger ([#3475](https://github.com/blink1073/node-mongodb-native/issues/3475)) ([6ef11d7](https://github.com/blink1073/node-mongodb-native/commit/6ef11d70c07e2e223d376e7527354ddf758a163a))
...
* **NODE-4817:** remove legacy logger ([#3518](https://github.com/blink1073/node-mongodb-native/issues/3518)) ([28c7cdd](https://github.com/blink1073/node-mongodb-native/commit/28c7cdd6a634f516092676e2e0e1e9272f8485cb))
* **NODE-4867:** adopt BSON v5 ([#3490](https://github.com/blink1073/node-mongodb-native/issues/3490)) ([b850868](https://github.com/blink1073/node-mongodb-native/commit/b850868eb217c98e86b9657d199ac938b1f0a97a))
...
* **NODE-4898:** aws credential providers now optional peerDependency ([#3497](https://github.com/blink1073/node-mongodb-native/issues/3497)) ([b9e4c7c](https://github.com/blink1073/node-mongodb-native/commit/b9e4c7c5f3f80a354090b92bd5162fc1c96e8e28))
* **NODE-4899:** support only snappy 7 or later ([#3491](https://github.com/blink1073/node-mongodb-native/issues/3491)) ([21db1a9](https://github.com/blink1073/node-mongodb-native/commit/21db1a9e4af0fa29cf84a151a2b93447400c67f0))
* **NODE-4924:** remove mapReduce collection helper ([#3511](https://github.com/blink1073/node-mongodb-native/issues/3511)) ([10d757a](https://github.com/blink1073/node-mongodb-native/commit/10d757a89e74b722d300450665f076aeae4970db))
* **NODE-4925:** remove deprecated options and types ([#3513](https://github.com/blink1073/node-mongodb-native/issues/3513)) ([8f8ea45](https://github.com/blink1073/node-mongodb-native/commit/8f8ea453bd3c03e5a5fe357d32821a1d5735ebcf))
...
* **NODE-4950:** remove bson-ext import ([#3523](https://github.com/blink1073/node-mongodb-native/issues/3523)) ([1470115](https://github.com/blink1073/node-mongodb-native/commit/147011599b0ad376116951e9058cfba3a67a06d0))
...
* **NODE-5016:** compile ts with target es2020 ([#3545](https://github.com/blink1073/node-mongodb-native/issues/3545)) ([def266a](https://github.com/blink1073/node-mongodb-native/commit/def266a63d3b6f4a2996e6e437fe8895a05666d8))
...
* **NODE-5399:** use mongodb-js/saslprep instead of saslprep ([#3818](https://github.com/blink1073/node-mongodb-native/issues/3818)) ([c0d3927](https://github.com/blink1073/node-mongodb-native/commit/c0d39273793d09cc9a0c1ca9955afaf77f9f62c6))
...
* **NODE-5429:** deprecate the `AutoEncrypter` interface ([#3764](https://github.com/blink1073/node-mongodb-native/issues/3764)) ([9bb0d95](https://github.com/blink1073/node-mongodb-native/commit/9bb0d955e73a6bc819992617c99c4406d7f9c550))
* **NODE-5465,NODE-5538:** lower `@aws-sdk/credential-providers` version to 3.188.0 and `zstd` to `^1.0.0` ([#3821](https://github.com/blink1073/node-mongodb-native/issues/3821)) ([39ff81d](https://github.com/blink1073/node-mongodb-native/commit/39ff81d40220e1fc03627fce8f5af85f11283e97))
* **NODE-5489:** update kerberos dependency ([8c25d6d](https://github.com/blink1073/node-mongodb-native/commit/8c25d6d0a7cb0a766f356e7320d09c964d21542b))
* **NODE-5564:** bump bson version to ^5.5.0 ([#3865](https://github.com/blink1073/node-mongodb-native/issues/3865)) ([dc110e0](https://github.com/blink1073/node-mongodb-native/commit/dc110e002e8194b9881a8c2aa140a8ce95f344c0))
* **NODE-5815:** remove oidc ([#3981](https://github.com/blink1073/node-mongodb-native/issues/3981)) ([4893330](https://github.com/blink1073/node-mongodb-native/commit/48933301caf293a1e76bff96ce7b1e7a8e321067))
* **NODE-5940:** cache the AWS credentials provider in the MONGODB-AWS auth logic ([#4000](https://github.com/blink1073/node-mongodb-native/issues/4000)) ([60bfc48](https://github.com/blink1073/node-mongodb-native/commit/60bfc483dba568c1a0f62a2a78d7ce50ed03082c))
* **NODE-5967:** container and Kubernetes awareness in client metadata ([#4011](https://github.com/blink1073/node-mongodb-native/issues/4011)) ([55c290a](https://github.com/blink1073/node-mongodb-native/commit/55c290ae9283c3194f9a043c2b66e66c50101617))


### Bug Fixes

* **NODE-3144:** pool clear event ordering and retryability tests ([#3407](https://github.com/blink1073/node-mongodb-native/issues/3407)) ([bdc0d67](https://github.com/blink1073/node-mongodb-native/commit/bdc0d675598805f725806f95714cf33aacf3d2dc))
* **NODE-3565:** Improve error message for insertMany with partially empty array ([#3221](https://github.com/blink1073/node-mongodb-native/issues/3221)) ([0ef2516](https://github.com/blink1073/node-mongodb-native/commit/0ef251655271b1a9200d5f23344092e9513c5379))
* **NODE-3712,NODE-4546:** electionId should be ordered before setVersion ([#3174](https://github.com/blink1073/node-mongodb-native/issues/3174)) ([ca51fec](https://github.com/blink1073/node-mongodb-native/commit/ca51feca25ab1413df7efe9e79b1de051ceb21eb))
* **NODE-3921:** error on invalid TLS option combinations ([#3405](https://github.com/blink1073/node-mongodb-native/issues/3405)) ([1a550df](https://github.com/blink1073/node-mongodb-native/commit/1a550df3aa328f8c1790c0e02cd1cdd4731b88f8))
* **NODE-3986:** unskip MONGODB-AWS test ([#3397](https://github.com/blink1073/node-mongodb-native/issues/3397)) ([5676f81](https://github.com/blink1073/node-mongodb-native/commit/5676f8116a7d07faf73f47b000a6fb2f462ab681))
...
* **NODE-4103:** respect BSON options when creating change streams ([#3247](https://github.com/blink1073/node-mongodb-native/issues/3247)) ([b2798d9](https://github.com/blink1073/node-mongodb-native/commit/b2798d939ee9ed7a5ff9a63980ad6a29ddea3cf1))
* **NODE-4108:** improve return type for withTransaction() ([#3236](https://github.com/blink1073/node-mongodb-native/issues/3236)) ([48e0e6e](https://github.com/blink1073/node-mongodb-native/commit/48e0e6ed17a5227b0781cbdf8c547824e5c26d59))
* **NODE-4125:** change stream resumability ([#3289](https://github.com/blink1073/node-mongodb-native/issues/3289)) ([aa5f97e](https://github.com/blink1073/node-mongodb-native/commit/aa5f97ec65ca49f5320812ae36044f525a8fd9c8))
* **NODE-4159,NODE-4512:** remove servers with incorrect setName from topology and fix unix socket parsing ([#3348](https://github.com/blink1073/node-mongodb-native/issues/3348)) ([00dcf2d](https://github.com/blink1073/node-mongodb-native/commit/00dcf2d51fb27c2b259f8dbf6aedf81196c5f98c))
* **NODE-4186:** accept ReadPreferenceLike in TransactionOptions type ([#3425](https://github.com/blink1073/node-mongodb-native/issues/3425)) ([dc62bcb](https://github.com/blink1073/node-mongodb-native/commit/dc62bcb158e52f4fbc6536f513bc2cab6d01640b))
* **NODE-4232:** stream() also returns generic AsyncIterable ([ed4ba58](https://github.com/blink1073/node-mongodb-native/commit/ed4ba587b991a8979d73af5ba6f3ff2690a21f85))
* **NODE-4254:** allow csfle to be dynamically required ([#3260](https://github.com/blink1073/node-mongodb-native/issues/3260)) ([cd6b5a0](https://github.com/blink1073/node-mongodb-native/commit/cd6b5a08964363d93be5d702476b5d331c78a7b2))
* **NODE-4262:** make startSession work without a connection ([#3286](https://github.com/blink1073/node-mongodb-native/issues/3286)) ([89ad7c3](https://github.com/blink1073/node-mongodb-native/commit/89ad7c3e5f3ae9ac485b7e1ff6699aed32e2eb34))
* **NODE-4273:** pass 'comment' option through to distinct command ([#3339](https://github.com/blink1073/node-mongodb-native/issues/3339)) ([753ecfe](https://github.com/blink1073/node-mongodb-native/commit/753ecfed437138808f21e31d436a58a44f3513b9))
* **NODE-4281:** ensure that the driver always uses Node.js timers ([#3275](https://github.com/blink1073/node-mongodb-native/issues/3275)) ([4501a1c](https://github.com/blink1073/node-mongodb-native/commit/4501a1ce55ba4adf141fdb851ccd33ff4f2a4e59))
* **NODE-4413:** set maxTimeMS on getMores when maxAwaitTimeMS is specified ([#3319](https://github.com/blink1073/node-mongodb-native/issues/3319)) ([dcbfd6e](https://github.com/blink1073/node-mongodb-native/commit/dcbfd6e943c2db2fbc223e221a6661996df25fe0))
* **NODE-4423:** better type support for nested objects in query & update ([#3328](https://github.com/blink1073/node-mongodb-native/issues/3328)) ([05e007b](https://github.com/blink1073/node-mongodb-native/commit/05e007b0b5ff98151c3ff972ee2f881b4203639e))
* **NODE-4425:** webpack optional import of FLE issue ([#3324](https://github.com/blink1073/node-mongodb-native/issues/3324)) ([5ab2b05](https://github.com/blink1073/node-mongodb-native/commit/5ab2b0517216b6675bed38824448fd9d598fd096))
* **NODE-4429:** select server sync for endSessions during close ([#3363](https://github.com/blink1073/node-mongodb-native/issues/3363)) ([5086ead](https://github.com/blink1073/node-mongodb-native/commit/5086eadf52e13369f584b9bd64477ab7f3522ff6))
* **NODE-4444:** use Node.js clear timers ([#3327](https://github.com/blink1073/node-mongodb-native/issues/3327)) ([c5cfe21](https://github.com/blink1073/node-mongodb-native/commit/c5cfe214ac320386033effc1b62967efa0eabf46))
* **NODE-4447:** disable causal consistency in implicit sessions ([#3479](https://github.com/blink1073/node-mongodb-native/issues/3479)) ([6566fb5](https://github.com/blink1073/node-mongodb-native/commit/6566fb58400c956bb5e56bd7c8affe2ebf2ce558))
* **NODE-4467:** Add back support for `oplogReplay` option as deprecated ([#3337](https://github.com/blink1073/node-mongodb-native/issues/3337)) ([6c69b7d](https://github.com/blink1073/node-mongodb-native/commit/6c69b7d51d98cf858607b0fdcad41d26691f97db))
* **NODE-4475:** make interrupted message more specific ([#3437](https://github.com/blink1073/node-mongodb-native/issues/3437)) ([5f37cb6](https://github.com/blink1073/node-mongodb-native/commit/5f37cb6454878294ae004d13a5fcf62eef6adbbe))
* **NODE-4496:** counter values incorrecly compared when instance of Long ([#3342](https://github.com/blink1073/node-mongodb-native/issues/3342)) ([d29eb8c](https://github.com/blink1073/node-mongodb-native/commit/d29eb8c2b683f0044accfdb2bb3c1770034f28f3))
* **NODE-4513:** type for nested objects in query & update ([#3349](https://github.com/blink1073/node-mongodb-native/issues/3349)) ([ec1a68f](https://github.com/blink1073/node-mongodb-native/commit/ec1a68f8cdf34763ad3797c3d2b663b55ede3e4e))
...
* **NODE-4533:** session support error message and unified test runner ([#3355](https://github.com/blink1073/node-mongodb-native/issues/3355)) ([6a0e502](https://github.com/blink1073/node-mongodb-native/commit/6a0e502139bb09d1eeadf01eb20461cf88d538b0))
* **NODE-4555:** export BSON internally ([#3367](https://github.com/blink1073/node-mongodb-native/issues/3367)) ([4ce6e4c](https://github.com/blink1073/node-mongodb-native/commit/4ce6e4cceea9117048d87af36c18da538f96a20f))
* **NODE-4557:** randomize servers when there are only 2 eligible servers ([#3390](https://github.com/blink1073/node-mongodb-native/issues/3390)) ([ddcfa49](https://github.com/blink1073/node-mongodb-native/commit/ddcfa49e753d0a674ad8a7b8e7c17a540d9734cc))
* **NODE-4583:** revert nested union type support ([#3383](https://github.com/blink1073/node-mongodb-native/issues/3383)) ([7f94f0a](https://github.com/blink1073/node-mongodb-native/commit/7f94f0a19d48cc3e779216a5b4c51881ab8ddbf0))
* **NODE-4591:** only set loadBalanced on handshake when explicitly set ([#3386](https://github.com/blink1073/node-mongodb-native/issues/3386)) ([57e9f2d](https://github.com/blink1073/node-mongodb-native/commit/57e9f2d9a617732f49c7e4dcfa3549912209584e))
* **NODE-4608:** prevent parallel monitor checks ([#3404](https://github.com/blink1073/node-mongodb-native/issues/3404)) ([78bcfe4](https://github.com/blink1073/node-mongodb-native/commit/78bcfe4834d03d7f85bd0aaaf8ffc3a316be372d))
* **NODE-4609:** allow mapping to falsey non-null values in cursors ([#3452](https://github.com/blink1073/node-mongodb-native/issues/3452)) ([1bf6ef1](https://github.com/blink1073/node-mongodb-native/commit/1bf6ef1792deb108f3fc58429b165e9bdd06b4a7))
* **NODE-4621:** ipv6 address handling in HostAddress ([#3410](https://github.com/blink1073/node-mongodb-native/issues/3410)) ([5eb3978](https://github.com/blink1073/node-mongodb-native/commit/5eb3978a71941b88d877f2121910f9612d15e9e5))
* **NODE-4639:** allow PromiseProvider to be null ([#3412](https://github.com/blink1073/node-mongodb-native/issues/3412)) ([d29b3d9](https://github.com/blink1073/node-mongodb-native/commit/d29b3d9db6824c048b75e6a74433d3638a41163f))
* **NODE-4647:** improve error message ([#3409](https://github.com/blink1073/node-mongodb-native/issues/3409)) ([0d3c02e](https://github.com/blink1073/node-mongodb-native/commit/0d3c02e25f5327d3200d8631a5472309d93a6c8c))
* **NODE-4649:** use SDAM handling for errors from min pool size population ([#3424](https://github.com/blink1073/node-mongodb-native/issues/3424)) ([ef3b55d](https://github.com/blink1073/node-mongodb-native/commit/ef3b55dd99eb52972e6cbebb4cb3d2ed2f72c081))
* **NODE-4735:** fix change stream consecutive resumabilty ([#3453](https://github.com/blink1073/node-mongodb-native/issues/3453)) ([89b27e9](https://github.com/blink1073/node-mongodb-native/commit/89b27e93e5416fb74ec716f3dc541c104c3a90ce))
* **NODE-4753:** remove erroneous deprecation of geoNear ([#3465](https://github.com/blink1073/node-mongodb-native/issues/3465)) ([199dcaf](https://github.com/blink1073/node-mongodb-native/commit/199dcaf7b462b1c488544cbdbaecaad0417c62d7))
* **NODE-4783:** handle orphaned operation descriptions ([#3463](https://github.com/blink1073/node-mongodb-native/issues/3463)) ([4c9b4d8](https://github.com/blink1073/node-mongodb-native/commit/4c9b4d846e5ba6e86d0d0592ff8bf76654d0fa51))
* **NODE-4830:** lazily import aws module ([#3476](https://github.com/blink1073/node-mongodb-native/issues/3476)) ([ff375e9](https://github.com/blink1073/node-mongodb-native/commit/ff375e9cfb84c85b7036a7ef0f87385d3ec126bb))
* **NODE-4831:** check map value is not undefined ([#3477](https://github.com/blink1073/node-mongodb-native/issues/3477)) ([9795cdb](https://github.com/blink1073/node-mongodb-native/commit/9795cdb19f8e652b4dc4badd4fe8e6d1a7b837a6))
* **NODE-4834:** ensure that MessageStream is destroyed when connections are destroyed ([#3482](https://github.com/blink1073/node-mongodb-native/issues/3482)) ([8338bae](https://github.com/blink1073/node-mongodb-native/commit/8338bae933c777dee4e7e49dbcf52c4fd7047528))
...
* **NODE-4998:** use ipv4 in socks5 tests for node 18 ([#3538](https://github.com/blink1073/node-mongodb-native/issues/3538)) ([425dbe0](https://github.com/blink1073/node-mongodb-native/commit/425dbe05d7bd1ebc1f77303332b67181aa5ab135))
...
* **NODE-5489:** set kerberos compatibility to ^1.0.0 || ^2.0.0 ([#3803](https://github.com/blink1073/node-mongodb-native/issues/3803)) ([c3b35b3](https://github.com/blink1073/node-mongodb-native/commit/c3b35b321b6ac0408af4dc10251c84a196a6f953))
* **NODE-5495:** do not emit deprecation warning when tlsCertificateKeyFile is specified and tlsCertificateFile is not ([#3810](https://github.com/blink1073/node-mongodb-native/issues/3810)) ([e81d4a2](https://github.com/blink1073/node-mongodb-native/commit/e81d4a2fc0ffc1d32dc3e124ceadd887e0a78ec4))
* **NODE-5537:** remove credentials from ConnectionPoolCreatedEvent options ([#3813](https://github.com/blink1073/node-mongodb-native/issues/3813)) ([4cf1e96](https://github.com/blink1073/node-mongodb-native/commit/4cf1e96c68410d743c592b27e8864917ca16e160))
* **NODE-5550:** set AWS region from environment variable for STSClient ([#3851](https://github.com/blink1073/node-mongodb-native/issues/3851)) ([2fab06b](https://github.com/blink1073/node-mongodb-native/commit/2fab06b2bdf019a0924fda24d6a81565350c28d6))
* **NODE-5572:** fix saslprep import ([#3837](https://github.com/blink1073/node-mongodb-native/issues/3837)) ([250dc21](https://github.com/blink1073/node-mongodb-native/commit/250dc213843a177938fc7bcd11c44a430f13e1fb))
* **NODE-5587:** recursive calls to next cause memory leak ([#3842](https://github.com/blink1073/node-mongodb-native/issues/3842)) ([f60f1b5](https://github.com/blink1073/node-mongodb-native/commit/f60f1b5f12522b32ea34a4db8cf750718f53e8b9))
* **NODE-5627:** BulkWriteResult.insertedIds includes ids that were not inserted ([#3870](https://github.com/blink1073/node-mongodb-native/issues/3870)) ([d766ae2](https://github.com/blink1073/node-mongodb-native/commit/d766ae22f3cfc6679ee3f7c068ebb8596beb4331))
* **NODE-5691:** make findOne() close implicit session to avoid memory leak ([#3889](https://github.com/blink1073/node-mongodb-native/issues/3889)) ([0d6c9cd](https://github.com/blink1073/node-mongodb-native/commit/0d6c9cde3badadc915821aa1f83d16f34dc29ee0))
* **NODE-5750:** RTTPinger always sends legacy hello ([#3922](https://github.com/blink1073/node-mongodb-native/issues/3922)) ([8e56872](https://github.com/blink1073/node-mongodb-native/commit/8e56872fd7a79c3d1cb0f215b55320c535cd6787))
* **NODE-5790:** type error with $addToSet in bulkWrite ([#3956](https://github.com/blink1073/node-mongodb-native/issues/3956)) ([f524a94](https://github.com/blink1073/node-mongodb-native/commit/f524a946ae99caf710220d264819187bd976af53))
* **NODE-5945:** make AWS session token optional ([#4006](https://github.com/blink1073/node-mongodb-native/issues/4006)) ([cbaf47a](https://github.com/blink1073/node-mongodb-native/commit/cbaf47a08dd478a8e469bd96e95a33fc8306802e))
* **NODE-6067:** make topology descriptions JSON stringifiable ([#4076](https://github.com/blink1073/node-mongodb-native/issues/4076)) ([7ae6eac](https://github.com/blink1073/node-mongodb-native/commit/7ae6eac967621c1a8bdd4f1fa5dc9c7dc3ec8269))
* sync showExpandedEvents spec tests ([#3288](https://github.com/blink1073/node-mongodb-native/issues/3288)) ([cfe18f9](https://github.com/blink1073/node-mongodb-native/commit/cfe18f966c6d40f3dcc874b668bac65640275449))


### Performance Improvements

* **NODE-4727:** Improve performance of buffering and cursors ([#3447](https://github.com/blink1073/node-mongodb-native/issues/3447)) ([78b2dd5](https://github.com/blink1073/node-mongodb-native/commit/78b2dd5fc2f591302975eb40ce334c6af8a72f1c))
...
* **NODE-4414:** Improve reliability of SDAM heartbeat error spec tests ([#3346](https://github.com/blink1073/node-mongodb-native/issues/3346)) ([417655a](https://github.com/blink1073/node-mongodb-native/commit/417655ac9d87c1c9ca255dfcc81ca828ffde731a))
