...
## [7.0.0](https://github.com/blink1073/node-mongodb-native/compare/v6.10.0...v7.0.0) (2024-11-05)
...
* **NODE-4696:** add FaaS env information to client metadata ([#3626](https://github.com/blink1073/node-mongodb-native/issues/3626)) ([0424080](https://github.com/blink1073/node-mongodb-native/commit/04240809f71bb8c2f88d50344d2b8d0d1d2ceea8))
...
* **NODE-4774:** deprecate cursor forEach ([#3622](https://github.com/blink1073/node-mongodb-native/issues/3622)) ([8d76a71](https://github.com/blink1073/node-mongodb-native/commit/8d76a7173fb8ac70c0f097366830da273c8a4d94))
* **NODE-4791:** deprecate duplicate bulk methods ([#3623](https://github.com/blink1073/node-mongodb-native/issues/3623)) ([2839e95](https://github.com/blink1073/node-mongodb-native/commit/2839e95256094cbf75fae2753d2e40551c04d87c))
* **NODE-4795:** deprecate addUser helper ([#3624](https://github.com/blink1073/node-mongodb-native/issues/3624)) ([53a0aae](https://github.com/blink1073/node-mongodb-native/commit/53a0aae584fb33b598e16dcea5dc559c3d8dca5e))
...
* **NODE-4877:** Add support for useBigInt64 ([#3519](https://github.com/blink1073/node-mongodb-native/issues/3519)) ([917668c](https://github.com/blink1073/node-mongodb-native/commit/917668c0bc42dbfa0a00869daa223f953f28c2e2))
...
* **NODE-5035:** enable OIDC authentication ([#3577](https://github.com/blink1073/node-mongodb-native/issues/3577)) ([35879f6](https://github.com/blink1073/node-mongodb-native/commit/35879f66dd1bd906d6b38cb7cd21ff1fb51c52a1))
* **NODE-5036:** reauthenticate OIDC and retry ([#3589](https://github.com/blink1073/node-mongodb-native/issues/3589)) ([a41846d](https://github.com/blink1073/node-mongodb-native/commit/a41846db3d769e2c10aedbf6feec53271fdb0a48))
* **NODE-5050:** support GCP automatic credential fetch for CSFLE ([#3574](https://github.com/blink1073/node-mongodb-native/issues/3574)) ([722a4a6](https://github.com/blink1073/node-mongodb-native/commit/722a4a6c613e4c169b51f14251a8fb4bebc1cf2a))
...
* **NODE-5077:** automatic Azure kms credential refresh ([#3599](https://github.com/blink1073/node-mongodb-native/issues/3599)) ([8e87e5c](https://github.com/blink1073/node-mongodb-native/commit/8e87e5c5be04902a75887c968f06325c1c7f0477))
...
* **NODE-5189:** deprecate tcp keepalive options ([#3621](https://github.com/blink1073/node-mongodb-native/issues/3621)) ([cc7c75a](https://github.com/blink1073/node-mongodb-native/commit/cc7c75a64720efe40b70f952e77c1d99d269bf06))
...
* **NODE-3998:** metadata duplication in handshake ([#3615](https://github.com/blink1073/node-mongodb-native/issues/3615)) ([6d894d6](https://github.com/blink1073/node-mongodb-native/commit/6d894d6652d6a286d8a699f4be0a7127a795b1ac))
* **NODE-4518:** error message with invalid authMechanism is provided (#undefined) ([1a16b7e](https://github.com/blink1073/node-mongodb-native/commit/1a16b7e2c4c2de9890591e9ac0196705684eb62c))
...
* **NODE-4854:** set timeout on write and reset on message ([#3582](https://github.com/blink1073/node-mongodb-native/issues/3582)) ([4a7b5ec](https://github.com/blink1073/node-mongodb-native/commit/4a7b5ec7dfcc3d0c4825ee939cb3eaf7bc79347b))
...
* **NODE-5042:** relax SRV record validation to account for a dot suffix ([#3633](https://github.com/blink1073/node-mongodb-native/issues/3633)) ([ad15881](https://github.com/blink1073/node-mongodb-native/commit/ad158811fb23f27d323f5fcada386abaa415fbe6))
* **NODE-5044:** Write Concern 0 Must Not Affect Read Operations ([#3541](https://github.com/blink1073/node-mongodb-native/issues/3541)) ([#3575](https://github.com/blink1073/node-mongodb-native/issues/3575)) ([10146a4](https://github.com/blink1073/node-mongodb-native/commit/10146a42fcc8d84cd07fb26bde9b2926deee6f1e))
* **NODE-5064:** consolidate connection cleanup logic and ensure socket is always closed ([#3572](https://github.com/blink1073/node-mongodb-native/issues/3572)) ([e544d88](https://github.com/blink1073/node-mongodb-native/commit/e544d880b1731fa59ad6a0d740b946e79478cfa6))
...
* **NODE-5106:** prevent multiple mongo client connect()s from leaking topology ([#3596](https://github.com/blink1073/node-mongodb-native/issues/3596)) ([eb836bb](https://github.com/blink1073/node-mongodb-native/commit/eb836bbd1d0029c78acead0ec985ec11ea94f978))
* **NODE-5126:** find operations fail when passed an ObjectId as filter ([#3604](https://github.com/blink1073/node-mongodb-native/issues/3604)) ([2647b61](https://github.com/blink1073/node-mongodb-native/commit/2647b6154069731f566a4066a01e5d75bc2318b0))
...
* **NODE-5171:** allow `upsertedId` to be null in `UpdateResult` ([#3631](https://github.com/blink1073/node-mongodb-native/issues/3631)) ([4b5be21](https://github.com/blink1073/node-mongodb-native/commit/4b5be2121fdcca0879447be24e8e935dfcd14764))
...
* **NODE-5017:** skip server selection for session support ([#3580](https://github.com/blink1073/node-mongodb-native/issues/3580)) ([591fc64](https://github.com/blink1073/node-mongodb-native/commit/591fc6487878584fd2b46a5531efbcd8c4f38d8a))
